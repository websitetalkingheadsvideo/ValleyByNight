<?php
/**
 * Boon Agent Character Reports Directory Index
 * Returns list of character report files as JSON for modal display
 */
        ...
        foreach ($files as $file) {
            ...
            if (is_file($file_path) && pathinfo($file, PATHINFO_EXTENSION) === 'json') {
                $file_info = [
                    ...
                    'url' => '../api_get_boon_report.php?type=character&file=' . urlencode($file)
                ];
                $reports[] = $file_info;
            }
        }
