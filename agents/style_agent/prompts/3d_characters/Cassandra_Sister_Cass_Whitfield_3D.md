# Cassandra "Sister Cass" Whitfield — 3D Character Generation Prompt

## Metadata
- Character ID: `061e80e5-b8ae-4347-908c-e9ca60d95e7d`
...
### Identity
- Character Name: Cassandra "Sister Cass" Whitfield
- Clan/Faction: Malkavian Antitribu
- Concept: Neonate oracle; a 1991 Embrace from Phoenix's late-night AM radio scene, obsessed with signals, patterns, and what's broadcasting on frequencies no one else can hear
...
Design language should communicate: Neonate oracle; a 1991 Embrace from Phoenix's late-night AM radio scene, obsessed with signals, patterns, and what's broadcasting on frequencies no one else can hear. Keep the visual psychology anchored in Visionary (inner driver) and Deviant (public mask).
Appearance foundation: Cassandra "Sister Cass" Whitfield presents a carefully managed visual identity that supports the role of neonate oracle; a 1991 embrace from phoenix's late-night am radio scene, obsessed with signals, patterns, and what's broadcasting on frequencies no one else can hear in Phoenix nights. As a Malkavian Antitribu aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that A lean woman in her late twenties, dressed in layers of thrift-store finds, with a battered transistor radio and one earpiece always in, and that first impression tends to hold under pressure. Their Nature reads as Visionary, while their Demeanor performs as Deviant, producing subtle contradictions that make them difficult to profile. Traits such as Beguiling, Bizarre, Charismatic, Clever, Clumsy, Disconcerting show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 3, Dementation 2, Obfuscate 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity 
...
Primary powers: Auspex 3, Dementation 2, Obfuscate 2
Traits: Clever, Erratic, Insightful, Intuitive, Observant, Unstable, Clumsy, Nimble, Quick, Beguiling, Bizarre, Charismatic
Abilities: Academics, Computer, Investigation, Occult, Stealth, Alertness, Expression, Intimidation, Streetwise, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Cassandra "Sister Cass" Whitfield. Clan/faction: Malkavian Antitribu. Core concept: Neonate oracle; a 1991 Embrace from Phoenix's late-night AM radio scene, obsessed with signals, patterns, and what's broadcasting on frequencies no one else can hear. Psychological axis: Visionary (inner driver) + Deviant (public mask).
...
Appearance direction: Cassandra "Sister Cass" Whitfield presents a carefully managed visual identity that supports the role of neonate oracle; a 1991 embrace from phoenix's late-night am radio scene, obsessed with signals, patterns, and what's broadcasting on frequencies no one else can hear in Phoenix nights. As a Malkavian Antitribu aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that A lean woman in her late twenties, dressed in layers of thrift-store finds, with a battered transisto
...
Discipline cues to encode subtly: Auspex 3, Dementation 2, Obfuscate 2.
