# Paulo Benedicto Giovanni — 3D Character Generation Prompt

## Metadata
- Character ID: `2c0a7f41-40b1-4bce-8c70-4fcfa1563deb`
...
### Identity
- Character Name: Paulo Benedicto Giovanni
- Clan/Faction: Giovanni
- Concept: Giovanni Director
...
Design language should communicate: Giovanni Director. Keep the visual psychology anchored in Survivor (inner driver) and Conformist (public mask).
Appearance foundation: Paulo Benedicto Giovanni moves through Phoenix's night with the practical efficiency of a survivor who's learned that adaptability is the only constant. The Embrace found him in his late twenties, and that maturity shows in the way he carries himself—medium build that speaks of strength without bulk, the kind of frame that can move quickly when it needs to but doesn't draw unnecessary attention. His light brown hair is kept practical, styled in a way that suggests function over form, and his face carries the lines of someone who's seen enough to know that survival isn't about looking good—it's about being ready. But it's his eyes that people remember. They're piercing in a way that goes beyond simple intensity—there's something almost predatory in their directness, a gaze that seems to assess threats and opportunities in the same moment. The Vision Mod that's part of his Szlachta modifications enhances what was already an alert, vigilant awareness, and when he looks at you, it feels like he's seeing more than you want him to see. The combination of his alert, attentive, determined traits creates a presence that's always processing, always calculating, always ready for whatever come
...
Primary powers: Dominate 5, Necromancy: Countermagic 5, Potence 5, Auspex 4, Celerity 4, Fortitude 4
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Finance, Hermetic Lore, Occult, Ritual Theory, Athletics, Alertness, Empathy, Etiquette, Expression, Intimidation, Leadership, Performance
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Paulo Benedicto Giovanni. Clan/faction: Giovanni. Core concept: Giovanni Director. Psychological axis: Survivor (inner driver) + Conformist (public mask).
...
Appearance direction: Paulo Benedicto Giovanni moves through Phoenix's night with the practical efficiency of a survivor who's learned that adaptability is the only constant. The Embrace found him in his late twenties, and that maturity shows in the way he carries himself—medium build that speaks of strength without bulk, the kind of frame that can move quickly when it needs to but doesn't draw unnecessary attention. His light brown hair is kept practical, styled in a way that suggests function over form, and his face carries the lines of someone who's seen enough t
...
Discipline cues to encode subtly: Dominate 5, Necromancy: Countermagic 5, Potence 5, Auspex 4, Celerity 4, Fortitude 4.
