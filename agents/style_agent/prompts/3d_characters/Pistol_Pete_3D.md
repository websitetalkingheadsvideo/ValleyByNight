# Pistol Pete — 3D Character Generation Prompt

## Metadata
- Character ID: `e18525b4-24c8-4c03-99d9-7e50e7a91144`
...
### Identity
- Character Name: Pistol Pete
- Clan/Faction: Brujah
- Concept: Rage Against the Machine / Street-Level Enforcer
- Nature / Demeanor: Rebel / Fanatic
...
Design language should communicate: Rage Against the Machine / Street-Level Enforcer. Keep the visual psychology anchored in Rebel (inner driver) and Fanatic (public mask).
Appearance foundation: Pistol Pete presents a carefully managed visual identity that supports the role of rage against the machine / street-level enforcer in Phoenix nights. As a Brujah aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Brujah brawler in battered leather jacket, scar-laced knuckles, and a revolver he twirls like a gunslinger, and that first impression tends to hold under pressure. Their Nature reads as Rebel, while their Demeanor performs as Fanatic, producing subtle contradictions that make them difficult to profile. Traits such as Aggressive, Focused, Independent, Intense, Passionate, Quick show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Potence 3, Celerity 2, Presence 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud:
...
Primary powers: Potence 3, Celerity 2, Presence 1
Traits: Focused, Independent, Aggressive, Quick, Intense, Passionate
Abilities: Awareness, Athletics, Brawl, Dodge, Drive, Firearms, Melee, Stealth, Survival, Alertness, Expression, Intimidation
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Pistol Pete. Clan/faction: Brujah. Core concept: Rage Against the Machine / Street-Level Enforcer. Psychological axis: Rebel (inner driver) + Fanatic (public mask).
...
Appearance direction: Pistol Pete presents a carefully managed visual identity that supports the role of rage against the machine / street-level enforcer in Phoenix nights. As a Brujah aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Brujah brawler in battered leather jacket, scar-laced knuckles, and a revolver he twirls like a gunslinger, and that first impression tends to hold under pressure. Their Nature reads as Rebel, while their Demeanor performs as Fanatic, producing subtle c
...
Discipline cues to encode subtly: Potence 3, Celerity 2, Presence 1.
