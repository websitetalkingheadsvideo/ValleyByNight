# Cordelia Fairchild — 3D Character Generation Prompt

## Metadata
- Character ID: `8fe1ab2f-d331-42b4-9932-66e056e6e85b`
...
### Identity
- Character Name: Cordelia Fairchild
- Clan/Faction: Toreador
- Concept: Elegant Harpy of Phoenix
- Nature / Demeanor: Critic / Architect
...
Design language should communicate: Elegant Harpy of Phoenix. Keep the visual psychology anchored in Critic (inner driver) and Architect (public mask).
Appearance foundation: Cordelia Fairchild presents a carefully managed visual identity that supports the role of elegant harpy of phoenix in Phoenix nights. As a Toreador aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Willowy and poised, dressed in tailored suits of burgundy and midnight blue, and that first impression tends to hold under pressure. Their Nature reads as Critic, while their Demeanor performs as Architect, producing subtle contradictions that make them difficult to profile. Traits such as Arrogant, Calculating, Charming, Commanding, Controlled, Eloquent show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 5, Celerity 5, Presence 5, Dominate 3 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 7, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negoti
...
Primary powers: Auspex 5, Celerity 5, Presence 5, Dominate 3, Animalism 2
Traits: Calculating, Insightful, Obsessive, Perceptive, Controlled, Graceful, Poised, Arrogant, Charming, Commanding, Eloquent, Manipulative
Abilities: Investigation, Occult, Politics, Alertness, Etiquette, Expression, Interrogation, Leadership, Streetwise, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Cordelia Fairchild. Clan/faction: Toreador. Core concept: Elegant Harpy of Phoenix. Psychological axis: Critic (inner driver) + Architect (public mask).
...
Appearance direction: Cordelia Fairchild presents a carefully managed visual identity that supports the role of elegant harpy of phoenix in Phoenix nights. As a Toreador aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Willowy and poised, dressed in tailored suits of burgundy and midnight blue, and that first impression tends to hold under pressure. Their Nature reads as Critic, while their Demeanor performs as Architect, producing subtle contradictions that make them difficult to p
...
Discipline cues to encode subtly: Auspex 5, Celerity 5, Presence 5, Dominate 3, Animalism 2.
