# Sofia Alvarez — 3D Character Generation Prompt

## Metadata
- Character ID: `c10f7c34-ab26-4f71-b7e2-033bd7eb2b05`
...
### Identity
- Character Name: Sofia Alvarez
- Clan/Faction: Ghoul
- Concept: The Spatial Empath / Conversational Architect
- Nature / Demeanor: Architect / Gallant
...
Design language should communicate: The Spatial Empath / Conversational Architect. Keep the visual psychology anchored in Architect (inner driver) and Gallant (public mask).
Appearance foundation: Sofia Alvarez moves through space like a conductor orchestrating an invisible symphony, her presence warm and confident but her eyes constantly mapping the geometry of every room she enters. Ghouled in 1986 at the age of thirty-two, she should appear to be in her early thirties after eight years of slow aging—and she does, but with the kind of vitality that speaks to someone who has found their purpose. She's of average height with a graceful, athletic build that suggests someone who understands how bodies move through space, and her face carries the strong, expressive features of Mediterranean heritage—dark eyes that seem to see everything, a warm smile that arrives easily, and olive-toned skin that glows in candlelight. Her clothing is a masterclass in structured elegance: tailored pieces in whites, grays, and soft metallics that create clean lines and emphasize her graceful frame. She favors architectural silhouettes—structured blazers with sharp shoulders, pencil skirts that move with her, and accessories that serve both form and function. A sketchbook is constantly in her hand, and she has a habit of pausing mid-conversation to make a quick notation—a light pattern, a seating 
...
Primary powers: Presence 2, Auspex 1
Traits: Attentive, Intelligent, Observant, Graceful, Alluring, Charismatic, Elegant, Persuasive
Abilities: Athletics, Brawl, Dodge, Melee, Alertness, Empathy, Etiquette, Expression, Intimidation, Leadership, Performance, Streetwise
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Sofia Alvarez. Clan/faction: Ghoul. Core concept: The Spatial Empath / Conversational Architect. Psychological axis: Architect (inner driver) + Gallant (public mask).
...
Appearance direction: Sofia Alvarez moves through space like a conductor orchestrating an invisible symphony, her presence warm and confident but her eyes constantly mapping the geometry of every room she enters. Ghouled in 1986 at the age of thirty-two, she should appear to be in her early thirties after eight years of slow aging—and she does, but with the kind of vitality that speaks to someone who has found their purpose. She's of average height with a graceful, athletic build that suggests someone who understands how bodies move through space, and her face carri
...
Discipline cues to encode subtly: Presence 2, Auspex 1.
