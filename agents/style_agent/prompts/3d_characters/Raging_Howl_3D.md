# Raging Howl — 3D Character Generation Prompt

## Metadata
- Character ID: `cc555cd2-80d2-4568-8b44-210e65df990d`
...
### Identity
- Character Name: Raging Howl
- Clan/Faction: Garou
- Concept: Urban Lupine / Vampire Hunter
- Nature / Demeanor: Survivor / Bravo
...
Design language should communicate: Urban Lupine / Vampire Hunter. Keep the visual psychology anchored in Survivor (inner driver) and Bravo (public mask).
Appearance foundation: Raging Howl presents a carefully managed visual identity that supports the role of urban lupine / vampire hunter in Phoenix nights. As a Garou aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that In human form, appears as homeless man living in city's largest park, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Bravo, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Celerity 4, Fortitude 4, Protean 4, Potence 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. Their moral center is less explicit in the record, but their styling still reads as controlled, purposeful, and anchored in long-term survival. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, and pla
...
Primary powers: Celerity 4, Fortitude 4, Protean 4, Potence 2, Auspex 1, Obfuscate 1
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Awareness, Crafts, Investigation, Medicine, Occult, Animal Ken, Athletics, Brawl, Stealth, Survival, Alertness, Expression
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Raging Howl. Clan/faction: Garou. Core concept: Urban Lupine / Vampire Hunter. Psychological axis: Survivor (inner driver) + Bravo (public mask).
...
Appearance direction: Raging Howl presents a carefully managed visual identity that supports the role of urban lupine / vampire hunter in Phoenix nights. As a Garou aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that In human form, appears as homeless man living in city's largest park, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Bravo, producing subtle contradictions that make them difficult to profile. Traits
...
Discipline cues to encode subtly: Celerity 4, Fortitude 4, Protean 4, Potence 2, Auspex 1, Obfuscate 1.
