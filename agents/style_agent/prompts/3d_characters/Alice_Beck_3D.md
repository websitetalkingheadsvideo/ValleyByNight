# Alice Beck — 3D Character Generation Prompt

## Metadata
- Character ID: `9420d2bf-ebac-486c-9a9e-0453e0e7a514`
...
### Identity
- Character Name: Alice Beck
- Clan/Faction: Mage
- Concept: Orphan Mage / Magical Serial Killer
...
Design language should communicate: Orphan Mage / Magical Serial Killer. Keep the visual psychology anchored in Survivor (inner driver) and Loner (public mask).
Appearance foundation: Alice Beck presents a carefully managed visual identity that supports the role of orphan mage / magical serial killer in Phoenix nights. As a Mage aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Pretty face, but otherwise unremarkable Caucasian woman with shoulder-length black hair, dressed in cheap, off-the-rack clothes, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Loner, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Thaumaturgy 4, Auspex 3, Fortitude 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. Their moral center is less explicit in the record, but their styling still reads as controlled, purposeful, and anchored in long-term survival. Taken together, the result is memorable without being loud: 
...
Primary powers: Thaumaturgy 4, Auspex 3, Fortitude 1
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Awareness, Medicine, Occult, Athletics, Brawl, Larceny, Melee, Stealth, Alertness, Empathy, Intimidation, Streetwise
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Alice Beck. Clan/faction: Mage. Core concept: Orphan Mage / Magical Serial Killer. Psychological axis: Survivor (inner driver) + Loner (public mask).
...
Appearance direction: Alice Beck presents a carefully managed visual identity that supports the role of orphan mage / magical serial killer in Phoenix nights. As a Mage aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Pretty face, but otherwise unremarkable Caucasian woman with shoulder-length black hair, dressed in cheap, off-the-rack clothes, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Loner, producing su
...
Discipline cues to encode subtly: Thaumaturgy 4, Auspex 3, Fortitude 1.
