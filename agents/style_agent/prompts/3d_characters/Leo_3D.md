# Leo — 3D Character Generation Prompt

## Metadata
- Character ID: `118b1db4-5427-4bb9-86b0-13d5d8bd69f9`
...
- Concept: The Invisible Hand / Data/Utility Infiltrator
- Nature / Demeanor: Survivor / Architect
...
Design language should communicate: The Invisible Hand / Data/Utility Infiltrator. Keep the visual psychology anchored in Survivor (inner driver) and Architect (public mask).
Appearance foundation: Leo presents a carefully managed visual identity that supports the role of the invisible hand / data/utility infiltrator in Phoenix nights. As a Nosferatu aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Gaunt Nosferatu with patchwork utility coveralls, hard hat fitted with jury-rigged headlamps, and a bandolier of tools, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Architect, producing subtle contradictions that make them difficult to profile. Traits such as Beguiling, Brawny, Brutal, Cunning, Dexterous, Insightful show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Obfuscate 3, Animalism 1, Potence 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 7, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without bei
...
Primary powers: Obfuscate 3, Animalism 1, Potence 1
Traits: Cunning, Insightful, Shrewd, Wily, Brawny, Brutal, Dexterous, Nimble, Vigorous, Beguiling
Abilities: Computer, Crafts, Investigation, Repair, Science, Security, Technology, Stealth, Survival, Alertness, Expression, Leadership
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Leo. Clan/faction: Nosferatu. Core concept: The Invisible Hand / Data/Utility Infiltrator. Psychological axis: Survivor (inner driver) + Architect (public mask).
...
Appearance direction: Leo presents a carefully managed visual identity that supports the role of the invisible hand / data/utility infiltrator in Phoenix nights. As a Nosferatu aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Gaunt Nosferatu with patchwork utility coveralls, hard hat fitted with jury-rigged headlamps, and a bandolier of tools, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Architect, producing
...
Discipline cues to encode subtly: Obfuscate 3, Animalism 1, Potence 1.
