# Paris Giovanni — 3D Character Generation Prompt

## Metadata
- Character ID: `b8bfeab2-1d9f-4fda-9f11-87286f276bf9`
...
### Identity
- Character Name: Paris Giovanni
- Clan/Faction: Giovanni
- Concept: Giovanni Arch-Necromancer
- Nature / Demeanor: Defender / Guru
- Sect Alignment: Independent
- Generation: 8
- Morality Context: Path of Lilith
...
Design language should communicate: Giovanni Arch-Necromancer. Keep the visual psychology anchored in Defender (inner driver) and Guru (public mask).
Appearance foundation: Paris Giovanni presents a carefully managed visual identity that supports the role of giovanni arch-necromancer in Phoenix nights. As a Giovanni aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Six feet tall, heavy-set, with burn scars tracing the left side of his face, and that first impression tends to hold under pressure. Their Nature reads as Defender, while their Demeanor performs as Guru, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Dominate 5, Potence 5, Celerity 4, Fortitude 4 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidatio
...
Primary powers: Dominate 5, Potence 5, Celerity 4, Fortitude 4, Necromancy: Ash Path 4, Necromancy: Bone Path 4
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Finance, Hermetic Lore, Occult, Ritual Theory, Brawl, Firearms, Security Ops, Alertness, Etiquette, Expression, Intimidation, Performance
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Paris Giovanni. Clan/faction: Giovanni. Core concept: Giovanni Arch-Necromancer. Psychological axis: Defender (inner driver) + Guru (public mask).
...
Appearance direction: Paris Giovanni presents a carefully managed visual identity that supports the role of giovanni arch-necromancer in Phoenix nights. As a Giovanni aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Six feet tall, heavy-set, with burn scars tracing the left side of his face, and that first impression tends to hold under pressure. Their Nature reads as Defender, while their Demeanor performs as Guru, producing subtle contradictions that make them difficult to profile
...
Discipline cues to encode subtly: Dominate 5, Potence 5, Celerity 4, Fortitude 4, Necromancy: Ash Path 4, Necromancy: Bone Path 4.
