# Aurial — 3D Character Generation Prompt

## Metadata
- Character ID: `c7bb1859-3520-44b5-9652-544b67bd8e3c`
...
### Identity
- Character Name: Aurial
- Clan/Faction: Spirit
- Concept: Power Broker Demon / Soul Merchant
- Nature / Demeanor: Manipulator / Confidant
...
Design language should communicate: Power Broker Demon / Soul Merchant. Keep the visual psychology anchored in Manipulator (inner driver) and Confidant (public mask).
Appearance foundation: Aurial presents a carefully managed visual identity that supports the role of power broker demon / soul merchant in Phoenix nights. As a Spirit aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Darkly handsome figure with bronze skin and blond hair, naked and holding golden coins in his fist when first summoned, and that first impression tends to hold under pressure. Their Nature reads as Manipulator, while their Demeanor performs as Confidant, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Daimoinon 4, Chimerstry 3, Obfuscate 3, Presence 3 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. Their moral center is less explicit in the record, but their styling still reads as controlled, purposeful, and anchored in long-term survival. Taken together, the result is memorable without bei
...
Primary powers: Daimoinon 4, Chimerstry 3, Obfuscate 3, Presence 3, Vicissitude 3, Auspex 2
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Academics, Awareness, Crafts, Finance, Investigation, Law, Occult, Politics, Athletics, Larceny, Stealth, Alertness
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Aurial. Clan/faction: Spirit. Core concept: Power Broker Demon / Soul Merchant. Psychological axis: Manipulator (inner driver) + Confidant (public mask).
...
Appearance direction: Aurial presents a carefully managed visual identity that supports the role of power broker demon / soul merchant in Phoenix nights. As a Spirit aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Darkly handsome figure with bronze skin and blond hair, naked and holding golden coins in his fist when first summoned, and that first impression tends to hold under pressure. Their Nature reads as Manipulator, while their Demeanor performs as Confidant, producing subtle 
...
Discipline cues to encode subtly: Daimoinon 4, Chimerstry 3, Obfuscate 3, Presence 3, Vicissitude 3, Auspex 2.
