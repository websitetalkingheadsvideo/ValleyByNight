# Andrei Radulescu — 3D Character Generation Prompt

## Metadata
- Character ID: `64d33e8f-c435-4bf8-b2e4-3299eb8f80c3`
...
### Identity
- Character Name: Andrei Radulescu
- Clan/Faction: Tremere
- Concept: Refugee Scholar
...
Design language should communicate: Refugee Scholar. Keep the visual psychology anchored in Survivor (inner driver) and Conformist (public mask).
Appearance foundation: Andrei Radulescu presents a carefully managed visual identity that supports the role of refugee scholar in Phoenix nights. As a Tremere aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Pale, studious, and often seen wearing outdated academic attire, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Conformist, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Clever, Determined, Focused, Intelligent, Loyal show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 2, Dehydrate Path (Experimental) 2, Path of Blood 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 7, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidatio
...
Primary powers: Auspex 2, Dehydrate Path (Experimental) 2, Path of Blood 2
Traits: Clever, Determined, Focused, Intelligent, Observant, Patient, Persistent, Resourceful, Studious, Alert, Nimble, Quick
Abilities: Academics, Investigation, Linguistics, Occult, Science, Stealth, Survival, Alertness, Streetwise, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Andrei Radulescu. Clan/faction: Tremere. Core concept: Refugee Scholar. Psychological axis: Survivor (inner driver) + Conformist (public mask).
...
Appearance direction: Andrei Radulescu presents a carefully managed visual identity that supports the role of refugee scholar in Phoenix nights. As a Tremere aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Pale, studious, and often seen wearing outdated academic attire, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Conformist, producing subtle contradictions that make them difficult to profile. Traits such a
...
Discipline cues to encode subtly: Auspex 2, Dehydrate Path (Experimental) 2, Path of Blood 2.
