# Eddy Valiant — 3D Character Generation Prompt

## Metadata
- Character ID: `b9596a40-5be9-4e69-ab5c-2ebda1ccf447`
...
### Identity
- Character Name: Eddy Valiant
- Clan/Faction: Malkavian
- Concept: Hard-boiled Malkavian private investigator
- Nature / Demeanor: Cynic / Gallant
...
Design language should communicate: Hard-boiled Malkavian private investigator. Keep the visual psychology anchored in Cynic (inner driver) and Gallant (public mask).
Appearance foundation: Eddy Valiant presents a carefully managed visual identity that supports the role of hard-boiled malkavian private investigator in Phoenix nights. As a Malkavian aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Heavyset and short, mid-40s in apparent age, and that first impression tends to hold under pressure. Their Nature reads as Cynic, while their Demeanor performs as Gallant, producing subtle contradictions that make them difficult to profile. Traits such as Appearance ••, Charisma •••, Dexterity •••, Intelligence •••, Manipulation ••••, Perception •••• show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 2, Dementation 2, Obfuscate 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negot
...
Primary powers: Auspex 2, Dementation 2, Obfuscate 2
Traits: Intelligence •••, Perception ••••, Wits, Dexterity •••, Stamina •••, Strength ••, Appearance ••, Charisma •••, Manipulation ••••
Abilities: Academics, Enigmas, Investigation, Law, Occult, Drive, Firearms, Stealth, Alertness, Empathy, Intimidation, Streetwise
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Eddy Valiant. Clan/faction: Malkavian. Core concept: Hard-boiled Malkavian private investigator. Psychological axis: Cynic (inner driver) + Gallant (public mask).
...
Appearance direction: Eddy Valiant presents a carefully managed visual identity that supports the role of hard-boiled malkavian private investigator in Phoenix nights. As a Malkavian aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Heavyset and short, mid-40s in apparent age, and that first impression tends to hold under pressure. Their Nature reads as Cynic, while their Demeanor performs as Gallant, producing subtle contradictions that make them difficult to profile. Traits such as
...
Discipline cues to encode subtly: Auspex 2, Dementation 2, Obfuscate 2.
