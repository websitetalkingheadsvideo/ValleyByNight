# Evan Mercer — 3D Character Generation Prompt

## Metadata
- Character ID: `03453a84-c452-4b4e-8ee1-efd67330f468`
...
### Identity
- Character Name: Evan Mercer
- Clan/Faction: Caitiff
- Concept: 13th-gen Caitiff neonate whose Blood feels thin and wrong — tolerated only because he’s useful
- Nature / Demeanor: Survivor / Watcher
...
Design language should communicate: 13th-gen Caitiff neonate whose Blood feels thin and wrong — tolerated only because he’s useful. Keep the visual psychology anchored in Survivor (inner driver) and Watcher (public mask).
Appearance foundation: Evan Mercer presents a carefully managed visual identity that supports the role of 13th-gen caitiff neonate whose blood feels thin and wrong — tolerated only because he’s useful in Phoenix nights. As a Caitiff aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Mid-to-late 20s, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Watcher, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 2, Celerity 2, Potence 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, and 
...
Abilities: Hermetic Lore, Occult, Ritual Theory, Alertness, Etiquette, Expression, Performance
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Evan Mercer. Clan/faction: Caitiff. Core concept: 13th-gen Caitiff neonate whose Blood feels thin and wrong — tolerated only because he’s useful. Psychological axis: Survivor (inner driver) + Watcher (public mask).
...
Appearance direction: Evan Mercer presents a carefully managed visual identity that supports the role of 13th-gen caitiff neonate whose blood feels thin and wrong — tolerated only because he’s useful in Phoenix nights. As a Caitiff aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Mid-to-late 20s, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Watcher, producing subtle contradictions that make them difficult to
