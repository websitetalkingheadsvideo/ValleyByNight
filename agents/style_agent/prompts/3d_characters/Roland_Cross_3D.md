# Roland Cross — 3D Character Generation Prompt

## Metadata
- Character ID: `2cd61927-e26a-4c76-a2f0-839a991f7069`
...
### Identity
- Character Name: Roland Cross
- Clan/Faction: Toreador
- Concept: Gunslinger Sheriff
- Nature / Demeanor: Survivor / Loner
...
Design language should communicate: Gunslinger Sheriff. Keep the visual psychology anchored in Survivor (inner driver) and Loner (public mask).
Appearance foundation: Roland Cross presents a carefully managed visual identity that supports the role of gunslinger sheriff in Phoenix nights. As a Toreador aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that A severe man with salt-and-pepper hair, wearing a worn leather duster and a heavy silver cross, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Loner, producing subtle contradictions that make them difficult to profile. Traits such as Callous, Commanding, Dexterous, Dexterous, Disciplined, Distant show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 5, Celerity 5, Presence 4, Fortitude 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 6, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for ne
...
Primary powers: Auspex 5, Celerity 5, Presence 4, Fortitude 2
Traits: Disciplined, Observant, Obsessive, Patient, Dexterous, Quick, Steady, Callous, Commanding, Distant, Intimidating
Abilities: Investigation, Law, Linguistics, Occult, Politics, Security, Athletics, Brawl, Dodge, Firearms, Melee, Stealth
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Roland Cross. Clan/faction: Toreador. Core concept: Gunslinger Sheriff. Psychological axis: Survivor (inner driver) + Loner (public mask).
...
Appearance direction: Roland Cross presents a carefully managed visual identity that supports the role of gunslinger sheriff in Phoenix nights. As a Toreador aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that A severe man with salt-and-pepper hair, wearing a worn leather duster and a heavy silver cross, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Loner, producing subtle contradictions that make them difficult
...
Discipline cues to encode subtly: Auspex 5, Celerity 5, Presence 4, Fortitude 2.
