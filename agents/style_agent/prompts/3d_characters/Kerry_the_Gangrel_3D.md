# Kerry, the Gangrel — 3D Character Generation Prompt

## Metadata
- Character ID: `a0644be5-2f9e-4247-b873-3ecd2483bca5`
...
### Identity
- Character Name: Kerry, the Gangrel
- Clan/Faction: Gangrel
- Concept: Feral hermit and accidental witness to a buried secret
...
Design language should communicate: Feral hermit and accidental witness to a buried secret. Keep the visual psychology anchored in Survivor (inner driver) and Loner (public mask).
Appearance foundation: Kerry, the Gangrel presents a carefully managed visual identity that supports the role of feral hermit and accidental witness to a buried secret in Phoenix nights. As a Gangrel aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Survivor, while their Demeanor performs as Loner, producing subtle contradictions that make them difficult to profile. Their posture, grooming, and timing imply trained situational awareness, with no wasted movement and no accidental tells. Disciplines including Animalism 4, Protean 4, Auspex 2, Fortitude 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. Their moral center is less explicit in the record, but their styling still reads as controlled, purposeful, and anchored in long-term survival. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, and plausible innocence in equal
...
Primary powers: Animalism 4, Protean 4, Auspex 2, Fortitude 2
Traits: none listed
Abilities: Animal Ken, Survival, Tracking, Alertness, Empathy, Etiquette, Expression, Leadership, Performance, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Kerry, the Gangrel. Clan/faction: Gangrel. Core concept: Feral hermit and accidental witness to a buried secret. Psychological axis: Survivor (inner driver) + Loner (public mask).
...
Appearance direction: Kerry, the Gangrel presents a carefully managed visual identity that supports the role of feral hermit and accidental witness to a buried secret in Phoenix nights. As a Gangrel aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Survivor, while their Demeanor performs as Loner, producing subtle contradictions that make them 
...
Discipline cues to encode subtly: Animalism 4, Protean 4, Auspex 2, Fortitude 2.
