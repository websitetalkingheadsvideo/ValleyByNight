# Betty — 3D Character Generation Prompt

## Metadata
- Character ID: `f4fbb9cb-a68e-4850-9ee7-3b9bdea67c64`
...
- Concept: Socialite
- Nature / Demeanor: Caregiver / Traditionalist
...
Design language should communicate: Socialite. Keep the visual psychology anchored in Caregiver (inner driver) and Traditionalist (public mask).
Appearance foundation: Betty presents a carefully managed visual identity that supports the role of socialite in Phoenix nights. As a Toreador aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Caregiver, while their Demeanor performs as Traditionalist, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Clever, Creative, Disciplined, Friendly, Intelligent show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Obfuscate 2, Animalism 1, Potence 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, and plausible innocence in 
...
Primary powers: Obfuscate 2, Animalism 1, Potence 1
Traits: Clever, Creative, Disciplined, Intelligent, Knowledgeable, Observant, Obsessed, Alert, Nimble, Repugnant (Nosferatu Curse), Friendly, Persuasive
Abilities: Computer, Investigation, Repair, Science, Security, Technology, Stealth, Alertness, Streetwise, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Betty. Clan/faction: Toreador. Core concept: Socialite. Psychological axis: Caregiver (inner driver) + Traditionalist (public mask).
...
Appearance direction: Betty presents a carefully managed visual identity that supports the role of socialite in Phoenix nights. As a Toreador aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Caregiver, while their Demeanor performs as Traditionalist, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Cle
...
Discipline cues to encode subtly: Obfuscate 2, Animalism 1, Potence 1.
