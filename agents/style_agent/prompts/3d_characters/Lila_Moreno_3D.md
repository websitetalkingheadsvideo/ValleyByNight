# Lila Moreno — 3D Character Generation Prompt

## Metadata
- Character ID: `01fb09bd-6c8d-4781-8866-fd94e74fd654`
...
### Identity
- Character Name: Lila Moreno
- Clan/Faction: Toreador
- Concept: Socialite & Muse
- Nature / Demeanor: Gallant / Celebrity
...
Design language should communicate: Socialite & Muse. Keep the visual psychology anchored in Gallant (inner driver) and Celebrity (public mask).
Appearance foundation: Lila Moreno presents a carefully managed visual identity that supports the role of socialite & muse in Phoenix nights. As a Toreador aligned with Camarilla politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Always draped in high-fashion silk, her dark eyes seem to see right through your bank account, and that first impression tends to hold under pressure. Their Nature reads as Gallant, while their Demeanor performs as Celebrity, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Presence 3, Auspex 2, Celerity 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, and
...
Primary powers: Presence 3, Auspex 2, Celerity 1
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Crafts, Hermetic Lore, Occult, Ritual Theory, Athletics, Brawl, Alertness, Empathy, Etiquette, Expression, Intimidation, Leadership
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Lila Moreno. Clan/faction: Toreador. Core concept: Socialite & Muse. Psychological axis: Gallant (inner driver) + Celebrity (public mask).
...
Appearance direction: Lila Moreno presents a carefully managed visual identity that supports the role of socialite & muse in Phoenix nights. As a Toreador aligned with Camarilla politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Always draped in high-fashion silk, her dark eyes seem to see right through your bank account, and that first impression tends to hold under pressure. Their Nature reads as Gallant, while their Demeanor performs as Celebrity, producing subtle contradictions that make them difficult to
...
Discipline cues to encode subtly: Presence 3, Auspex 2, Celerity 1.
