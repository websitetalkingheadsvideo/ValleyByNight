# Roxanne Murphy — 3D Character Generation Prompt

## Metadata
- Character ID: `5c7e147c-dff0-432d-a195-2ae5fde2a676`
...
### Identity
- Character Name: Roxanne Murphy
- Clan/Faction: Followers of Set
- Concept: Setite Temple-Mistress
- Nature / Demeanor: Visionary / Priestess
...
Design language should communicate: Setite Temple-Mistress. Keep the visual psychology anchored in Visionary (inner driver) and Priestess (public mask).
Appearance foundation: Roxanne Murphy presents a carefully managed visual identity that supports the role of setite temple-mistress in Phoenix nights. As a Followers of Set aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Favors Egyptian-inspired jewelry and rich fabrics; often seen in warm, low-lit private levels, and that first impression tends to hold under pressure. Their Nature reads as Visionary, while their Demeanor performs as Priestess, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Obfuscate 2, Presence 2, Serpentis 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negot
...
Abilities: Hermetic Lore, Investigation, Occult, Ritual Theory, Stealth, Etiquette, Expression, Performance, Streetwise, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Roxanne Murphy. Clan/faction: Followers of Set. Core concept: Setite Temple-Mistress. Psychological axis: Visionary (inner driver) + Priestess (public mask).
...
Appearance direction: Roxanne Murphy presents a carefully managed visual identity that supports the role of setite temple-mistress in Phoenix nights. As a Followers of Set aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Favors Egyptian-inspired jewelry and rich fabrics; often seen in warm, low-lit private levels, and that first impression tends to hold under pressure. Their Nature reads as Visionary, while their Demeanor performs as Priestess, producing subtle contradictions that m
