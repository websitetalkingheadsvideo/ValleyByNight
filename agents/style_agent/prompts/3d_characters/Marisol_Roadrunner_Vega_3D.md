# Marisol "Roadrunner" Vega — 3D Character Generation Prompt

## Metadata
- Character ID: `66547fa1-3c25-4e8b-9ea7-f440e1ec0437`
...
### Identity
- Character Name: Marisol "Roadrunner" Vega
- Clan/Faction: Gangrel
- Concept: Courier
- Nature / Demeanor: Rebel / Survivor
...
Design language should communicate: Courier. Keep the visual psychology anchored in Rebel (inner driver) and Survivor (public mask).
Appearance foundation: Marisol "Roadrunner" Vega presents a carefully managed visual identity that supports the role of courier in Phoenix nights. As a Gangrel aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Wiry and athletic, usually seen in scuffed motorcycle leathers with a helmet tucked under one arm, and that first impression tends to hold under pressure. Their Nature reads as Rebel, while their Demeanor performs as Survivor, producing subtle contradictions that make them difficult to profile. Traits such as Agile, Alert, Athletic, Cunning, Fit, Independent show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including protean 3, animalism 2, fortitude 2, auspex 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation,
...
Primary powers: protean 3, animalism 2, fortitude 2, auspex 1, celerity 1, dominate 1
Traits: Alert, Cunning, Intuitive, Perceptive, Agile, Athletic, Fit, Quick, Resilient, Tough, Independent, Observant
Abilities: Awareness, Investigation, Animal Ken, Athletics, Brawl, Drive, Firearms, Melee, Stealth, Survival, Alertness, Streetwise
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Marisol "Roadrunner" Vega. Clan/faction: Gangrel. Core concept: Courier. Psychological axis: Rebel (inner driver) + Survivor (public mask).
...
Appearance direction: Marisol "Roadrunner" Vega presents a carefully managed visual identity that supports the role of courier in Phoenix nights. As a Gangrel aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Wiry and athletic, usually seen in scuffed motorcycle leathers with a helmet tucked under one arm, and that first impression tends to hold under pressure. Their Nature reads as Rebel, while their Demeanor performs as Survivor, producing subtle contradictions that make them diffi
...
Discipline cues to encode subtly: protean 3, animalism 2, fortitude 2, auspex 1, celerity 1, dominate 1.
