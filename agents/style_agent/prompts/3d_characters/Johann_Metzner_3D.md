# Johann Metzner — 3D Character Generation Prompt

## Metadata
- Character ID: `70dd5c83-2bd5-4cb2-aaac-e21fb87fb937`
...
### Identity
- Character Name: Johann Metzner
- Clan/Faction: Mage
- Concept: Eternal Alchemist / Immortal Scholar
- Nature / Demeanor: Perfectionist / Enigma
...
Design language should communicate: Eternal Alchemist / Immortal Scholar. Keep the visual psychology anchored in Perfectionist (inner driver) and Enigma (public mask).
Appearance foundation: Johann Metzner presents a carefully managed visual identity that supports the role of eternal alchemist / immortal scholar in Phoenix nights. As a Mage aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Highly unremarkable man, short, dark-haired, dressed in a modern business suit, and that first impression tends to hold under pressure. Their Nature reads as Perfectionist, while their Demeanor performs as Enigma, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 2, Fortitude 2, Thaumaturgy 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. Their moral center is less explicit in the record, but their styling still reads as controlled, purposeful, and anchored in long-term survival. Taken together, the result is memorable without being loud: a persona built for negotiation, intim
...
Primary powers: Auspex 2, Fortitude 2, Thaumaturgy 2
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Academics, Awareness, Crafts, Finance, Medicine, Occult, Science, Athletics, Larceny, Melee, Stealth, Alertness
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Johann Metzner. Clan/faction: Mage. Core concept: Eternal Alchemist / Immortal Scholar. Psychological axis: Perfectionist (inner driver) + Enigma (public mask).
...
Appearance direction: Johann Metzner presents a carefully managed visual identity that supports the role of eternal alchemist / immortal scholar in Phoenix nights. As a Mage aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Highly unremarkable man, short, dark-haired, dressed in a modern business suit, and that first impression tends to hold under pressure. Their Nature reads as Perfectionist, while their Demeanor performs as Enigma, producing subtle contradictions that make them dif
...
Discipline cues to encode subtly: Auspex 2, Fortitude 2, Thaumaturgy 2.
