# Urban Spirit — 3D Character Generation Prompt

## Metadata
- Character ID: `12bffe7d-4895-4f82-a240-c7f57a5f43e5`
...
### Identity
- Character Name: Urban Spirit
- Clan/Faction: Spirit
- Concept: Corrupted Forest Spirit / Urban Bane
- Nature / Demeanor: Monster / Enigma
...
Design language should communicate: Corrupted Forest Spirit / Urban Bane. Keep the visual psychology anchored in Monster (inner driver) and Enigma (public mask).
Appearance foundation: Urban Spirit presents a carefully managed visual identity that supports the role of corrupted forest spirit / urban bane in Phoenix nights. As a Spirit aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that In the spirit world, appears as a warped and crooked tree with diseased branches, and that first impression tends to hold under pressure. Their Nature reads as Monster, while their Demeanor performs as Enigma, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 5, Fortitude 5, Dementation 4, Potence 3 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. Their moral center is less explicit in the record, but their styling still reads as controlled, purposeful, and anchored in long-term survival. Taken together, the result is memorable without being loud: a persona built for negotiation
...
Primary powers: Auspex 5, Fortitude 5, Dementation 4, Potence 3, Animalism 2
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Awareness, Occult, Animal Ken, Athletics, Brawl, Stealth, Survival, Alertness, Empathy, Expression, Intimidation, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Urban Spirit. Clan/faction: Spirit. Core concept: Corrupted Forest Spirit / Urban Bane. Psychological axis: Monster (inner driver) + Enigma (public mask).
...
Appearance direction: Urban Spirit presents a carefully managed visual identity that supports the role of corrupted forest spirit / urban bane in Phoenix nights. As a Spirit aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that In the spirit world, appears as a warped and crooked tree with diseased branches, and that first impression tends to hold under pressure. Their Nature reads as Monster, while their Demeanor performs as Enigma, producing subtle contradictions that make them difficu
...
Discipline cues to encode subtly: Auspex 5, Fortitude 5, Dementation 4, Potence 3, Animalism 2.
