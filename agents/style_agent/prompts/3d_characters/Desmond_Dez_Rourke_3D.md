# Desmond "Dez" Rourke — 3D Character Generation Prompt

## Metadata
- Character ID: `6bfae5eb-4f55-44c7-9e17-cc9df4c1ae26`
...
### Identity
- Character Name: Desmond "Dez" Rourke
- Clan/Faction: Brujah Antitribu
- Concept: Neonate enforcer; a 1988 embrace from Phoenix's punk scene, all rage and loyalty with no filter between the two
- Nature / Demeanor: Bravo / Rebel
...
Design language should communicate: Neonate enforcer; a 1988 embrace from Phoenix's punk scene, all rage and loyalty with no filter between the two. Keep the visual psychology anchored in Bravo (inner driver) and Rebel (public mask).
Appearance foundation: Desmond "Dez" Rourke presents a carefully managed visual identity that supports the role of neonate enforcer; a 1988 embrace from phoenix's punk scene, all rage and loyalty with no filter between the two in Phoenix nights. As a Brujah Antitribu aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that A wiry man in his early thirties with a prominent scar from his left ear to his jaw, and that first impression tends to hold under pressure. Their Nature reads as Bravo, while their Demeanor performs as Rebel, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Brusque, Brutal, Brutal, Determined, Ferocious show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Potence 3, Celerity 2, Presence 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 4, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken tog
...
Traits: Alert, Determined, Focused, Impatient, Shortsighted, Brutal, Ferocious, Quick, Tireless, Wiry, Brusque, Intimidating
Abilities: Occult, Ritual Theory, Security, Athletics, Brawl, Dodge, Firearms, Melee, Stealth, Survival, Alertness, Intimidation
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Desmond "Dez" Rourke. Clan/faction: Brujah Antitribu. Core concept: Neonate enforcer; a 1988 embrace from Phoenix's punk scene, all rage and loyalty with no filter between the two. Psychological axis: Bravo (inner driver) + Rebel (public mask).
...
Appearance direction: Desmond "Dez" Rourke presents a carefully managed visual identity that supports the role of neonate enforcer; a 1988 embrace from phoenix's punk scene, all rage and loyalty with no filter between the two in Phoenix nights. As a Brujah Antitribu aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that A wiry man in his early thirties with a prominent scar from his left ear to his jaw, and that first impression tends to hold under pressure. Their Nature reads as Bravo, w
