# Piston — 3D Character Generation Prompt

## Metadata
- Character ID: `0f2a213b-cbf1-49cd-97f7-8f91e0136888`
...
### Identity
- Character Name: Piston
- Clan/Faction: Brujah
- Concept: Anarch Street Fighter / Diablerist
- Nature / Demeanor: Rebel / Thug
...
Design language should communicate: Anarch Street Fighter / Diablerist. Keep the visual psychology anchored in Rebel (inner driver) and Thug (public mask).
Appearance foundation: Piston presents a carefully managed visual identity that supports the role of anarch street fighter / diablerist in Phoenix nights. As a Brujah aligned with Anarch politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Built like a diesel engine with scarred knuckles and black veins visible to Auspex, and that first impression tends to hold under pressure. Their Nature reads as Rebel, while their Demeanor performs as Thug, producing subtle contradictions that make them difficult to profile. Traits such as Aggressive, Athletic, Blunt, Brotherly, Direct, Imposing show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Celerity 2, Fortitude 2, Potence 2, Presence 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 6, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimida
...
Primary powers: Celerity 2, Fortitude 2, Potence 2, Presence 2
Traits: Impulsive, Instinctive, Practical, Reckless, Streetwise, Survivor, Athletic, Imposing, Resilient, Strong, Tough, Aggressive
Abilities: Investigation, Brawl, Dodge, Drive, Firearms, Melee, Stealth, Survival, Alertness, Intimidation, Streetwise
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Piston. Clan/faction: Brujah. Core concept: Anarch Street Fighter / Diablerist. Psychological axis: Rebel (inner driver) + Thug (public mask).
...
Appearance direction: Piston presents a carefully managed visual identity that supports the role of anarch street fighter / diablerist in Phoenix nights. As a Brujah aligned with Anarch politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Built like a diesel engine with scarred knuckles and black veins visible to Auspex, and that first impression tends to hold under pressure. Their Nature reads as Rebel, while their Demeanor performs as Thug, producing subtle contradictions that make them difficult to profile. 
...
Discipline cues to encode subtly: Celerity 2, Fortitude 2, Potence 2, Presence 2.
