# Adrian Leclair — 3D Character Generation Prompt

## Metadata
- Character ID: `09ec8d0c-2ed8-4440-88c4-17bce73ec400`
...
### Identity
- Character Name: Adrian Leclair
- Clan/Faction: Toreador
- Concept: Toreador interior artist who sculpts emotional spaces
...
Abilities: Academics, Awareness, Crafts, Finance, Investigation, Politics, Alertness, Empathy, Etiquette, Expression, Leadership, Performance
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Adrian Leclair. Clan/faction: Toreador. Core concept: Toreador interior artist who sculpts emotional spaces. Psychological axis: Architect (inner driver) + Director (public mask).
...
Appearance direction: Adrian Leclair moves through space like a conductor orchestrating an invisible symphony, his presence so attuned to the emotional currents of a room that he seems to shape them simply by existing. Embraced in post-war Europe for his precision in shaping beauty, he presents as a man in his early forties—the perfect age of artistic maturity, frozen at the moment when experience and vision align. He's tall and elegantly built, with the kind of frame that suggests someone who understands how bodies move through space, and his face carries the refin
