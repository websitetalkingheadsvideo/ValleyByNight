# The Warlock — 3D Character Generation Prompt

## Metadata
- Character ID: `2fb91c78-acbf-40be-a06d-b803780dcdb0`
...
### Identity
- Character Name: The Warlock
- Clan/Faction: Tremere Antitribu
- Concept: Pack Sorcerer; Tremere Antitribu who provides the Painted Desert Pack with Thaumaturgy and ritual support, keeps to himself, and is known to the pack only by his role
- Nature / Demeanor: Deviant / Conformist
- Sect Alignment: Independent
- Generation: 10
- Morality Context: Humanity, rating 4
...
Design language should communicate: Pack Sorcerer; Tremere Antitribu who provides the Painted Desert Pack with Thaumaturgy and ritual support, keeps to himself, and is known to the pack only by his role. Keep the visual psychology anchored in Deviant (inner driver) and Conformist (public mask).
Appearance foundation: The Warlock presents a carefully managed visual identity that supports the role of pack sorcerer; tremere antitribu who provides the painted desert pack with thaumaturgy and ritual support, keeps to himself, and is known to the pack only by his role in Phoenix nights. As a Tremere Antitribu aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that A man of indeterminate age with a reserved, scholarly bearing, and that first impression tends to hold under pressure. Their Nature reads as Deviant, while their Demeanor performs as Conformist, producing subtle contradictions that make them difficult to profile. Traits such as Aloof, Clever, Cold, Controlled, Distrustful, Knowledgeable show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Thaumaturgy 3, Auspex 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 4, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from beco
...
Primary powers: Thaumaturgy 3, Auspex 1
Traits: Clever, Knowledgeable, Meticulous, Observant, Controlled, Reserved, Aloof, Cold, Distrustful, Secretive
Abilities: Academics, Investigation, Linguistics, Occult, Research, Stealth, Alertness, Interrogation, Intimidation, Streetwise, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: The Warlock. Clan/faction: Tremere Antitribu. Core concept: Pack Sorcerer; Tremere Antitribu who provides the Painted Desert Pack with Thaumaturgy and ritual support, keeps to himself, and is known to the pack only by his role. Psychological axis: Deviant (inner driver) + Conformist (public mask).
...
Appearance direction: The Warlock presents a carefully managed visual identity that supports the role of pack sorcerer; tremere antitribu who provides the painted desert pack with thaumaturgy and ritual support, keeps to himself, and is known to the pack only by his role in Phoenix nights. As a Tremere Antitribu aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that A man of indeterminate age with a reserved, scholarly bearing, and that first impression tends to hold under pressure. Their
...
Discipline cues to encode subtly: Thaumaturgy 3, Auspex 1.
