# Tariq Ibrahim — 3D Character Generation Prompt

## Metadata
- Character ID: `518de335-4fcf-4ec4-a2f0-877ff0add741`
...
### Identity
- Character Name: Tariq Ibrahim
- Clan/Faction: Followers of Set
- Concept: Setite Nightlife Impresario
- Nature / Demeanor: Temptress / Confidant
...
Design language should communicate: Setite Nightlife Impresario. Keep the visual psychology anchored in Temptress (inner driver) and Confidant (public mask).
Appearance foundation: Tariq Ibrahim presents a carefully managed visual identity that supports the role of setite nightlife impresario in Phoenix nights. As a Followers of Set aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Moves like a serpent in silk, wearing tailored dark burgundy and midnight blue pieces, and that first impression tends to hold under pressure. Their Nature reads as Temptress, while their Demeanor performs as Confidant, producing subtle contradictions that make them difficult to profile. Traits such as Alluring, Charismatic, Commanding, Cunning, Discerning, Elegant show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Presence 3, Serpentis 3, Obfuscate 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 7, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built f
...
Primary powers: Presence 3, Serpentis 3, Obfuscate 2
Traits: Cunning, Discerning, Shrewd, Alluring, Charismatic, Commanding, Elegant, Eloquent, Persuasive
Abilities: Awareness, Finance, Investigation, Occult, Politics, Alertness, Empathy, Etiquette, Expression, Intimidation, Leadership, Performance
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Tariq Ibrahim. Clan/faction: Followers of Set. Core concept: Setite Nightlife Impresario. Psychological axis: Temptress (inner driver) + Confidant (public mask).
...
Appearance direction: Tariq Ibrahim presents a carefully managed visual identity that supports the role of setite nightlife impresario in Phoenix nights. As a Followers of Set aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Moves like a serpent in silk, wearing tailored dark burgundy and midnight blue pieces, and that first impression tends to hold under pressure. Their Nature reads as Temptress, while their Demeanor performs as Confidant, producing subtle contradictions that make 
...
Discipline cues to encode subtly: Presence 3, Serpentis 3, Obfuscate 2.
