# Marianna Giovanni — 3D Character Generation Prompt

## Metadata
- Character ID: `fbc9acdc-73d7-4013-af5a-abce744e3290`
...
### Identity
- Character Name: Marianna Giovanni
- Clan/Faction: Giovanni
- Concept: Giovanni Financial Strategist
- Nature / Demeanor: Architect / Penitent
...
Design language should communicate: Giovanni Financial Strategist. Keep the visual psychology anchored in Architect (inner driver) and Penitent (public mask).
Appearance foundation: Marianna Giovanni presents a carefully managed visual identity that supports the role of giovanni financial strategist in Phoenix nights. As a Giovanni aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Fair-skinned with dark, slicked-back hair and a commanding pinstripe three-piece suit, and that first impression tends to hold under pressure. Their Nature reads as Architect, while their Demeanor performs as Penitent, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Necromancy: Sepulchre Path 3, Potence 3, Celerity 2, Dominate 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a per
...
- Material style: old-world formalwear, dark tailoring, period jewelry, restrained funerary motifs
...
Primary powers: Necromancy: Sepulchre Path 3, Potence 3, Celerity 2, Dominate 2, Fortitude 2, Necromancy: Ash Path 2
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Finance, Hermetic Lore, Occult, Ritual Theory, Alertness, Empathy, Etiquette, Expression, Intimidation, Performance, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Marianna Giovanni. Clan/faction: Giovanni. Core concept: Giovanni Financial Strategist. Psychological axis: Architect (inner driver) + Penitent (public mask).
...
Appearance direction: Marianna Giovanni presents a carefully managed visual identity that supports the role of giovanni financial strategist in Phoenix nights. As a Giovanni aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Fair-skinned with dark, slicked-back hair and a commanding pinstripe three-piece suit, and that first impression tends to hold under pressure. Their Nature reads as Architect, while their Demeanor performs as Penitent, producing subtle contradictions that make the
...
Discipline cues to encode subtly: Necromancy: Sepulchre Path 3, Potence 3, Celerity 2, Dominate 2, Fortitude 2, Necromancy: Ash Path 2.
