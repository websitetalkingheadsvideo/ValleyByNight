# Lilith Nightshade — 3D Character Generation Prompt

## Metadata
- Character ID: `cb4ff01e-1377-4925-8981-7076fa035b83`
...
### Identity
- Character Name: Lilith Nightshade
- Clan/Faction: Malkavian
- Concept: Mystic
- Nature / Demeanor: Enigma / Loner
...
Design language should communicate: Mystic. Keep the visual psychology anchored in Enigma (inner driver) and Loner (public mask).
Appearance foundation: Lilith Nightshade presents a carefully managed visual identity that supports the role of mystic in Phoenix nights. As a Malkavian aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Wispy and ethereal, wearing diaphanous black veils that seem to move even when there is no wind, and that first impression tends to hold under pressure. Their Nature reads as Enigma, while their Demeanor performs as Loner, producing subtle contradictions that make them difficult to profile. Traits such as Authoritative, Charismatic, Distracted by Visions, Elegant, Focused When Driven, Graceful show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 5, Dementation 5, Obfuscate 3 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona bu
...
Primary powers: Auspex 5, Dementation 5, Obfuscate 3
Traits: Distracted by Visions, Focused When Driven, Haunted, Insightful, Perceptive, Graceful, Poised, Authoritative, Charismatic, Elegant, Magnetic, Unsettling
Abilities: Awareness, Investigation, Occult, Stealth, Empathy, Etiquette, Intimidation, Performance, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Lilith Nightshade. Clan/faction: Malkavian. Core concept: Mystic. Psychological axis: Enigma (inner driver) + Loner (public mask).
...
Appearance direction: Lilith Nightshade presents a carefully managed visual identity that supports the role of mystic in Phoenix nights. As a Malkavian aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Wispy and ethereal, wearing diaphanous black veils that seem to move even when there is no wind, and that first impression tends to hold under pressure. Their Nature reads as Enigma, while their Demeanor performs as Loner, producing subtle contradictions that make them difficult to pro
...
Discipline cues to encode subtly: Auspex 5, Dementation 5, Obfuscate 3.
