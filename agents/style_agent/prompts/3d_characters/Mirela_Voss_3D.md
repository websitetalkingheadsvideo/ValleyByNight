# Mirela Voss — 3D Character Generation Prompt

## Metadata
- Character ID: `213cb990-28b6-4cb6-804d-85465d957905`
...
### Identity
- Character Name: Mirela Voss
- Clan/Faction: Tzimisce
- Concept: Pack Priest; Tzimisce scholar who views the Sonoran Desert as a canvas for Vicissitude experiments
- Nature / Demeanor: Architect / Deviant
- Sect Alignment: Independent
- Generation: 10
- Morality Context: Path of Metamorphosis, rating 3
...
Design language should communicate: Pack Priest; Tzimisce scholar who views the Sonoran Desert as a canvas for Vicissitude experiments. Keep the visual psychology anchored in Architect (inner driver) and Deviant (public mask).
Appearance foundation: Mirela Voss presents a carefully managed visual identity that supports the role of pack priest; tzimisce scholar who views the sonoran desert as a canvas for vicissitude experiments in Phoenix nights. As a Tzimisce aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that A lithe, wiry woman of Romanian cast with an ageless ancilla bearing, and that first impression tends to hold under pressure. Their Nature reads as Architect, while their Demeanor performs as Deviant, producing subtle contradictions that make them difficult to profile. Traits such as Bestial, Clever, Cold, Commanding, Commanding, Intimidating show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Vicissitude 4, Animalism 2, Auspex 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 3, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable
...
- Material style: aristocratic silhouettes with unsettling anatomical precision, organic-leather blends
...
Primary powers: Vicissitude 4, Animalism 2, Auspex 2
Traits: Clever, Knowledgeable, Meticulous, Observant, Lithe, Nimble, Wiry, Bestial, Cold, Commanding, Intimidating
Abilities: Academics, Investigation, Medicine, Occult, Science, Brawl, Stealth, Survival, Alertness, Intimidation, Leadership
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Mirela Voss. Clan/faction: Tzimisce. Core concept: Pack Priest; Tzimisce scholar who views the Sonoran Desert as a canvas for Vicissitude experiments. Psychological axis: Architect (inner driver) + Deviant (public mask).
...
Appearance direction: Mirela Voss presents a carefully managed visual identity that supports the role of pack priest; tzimisce scholar who views the sonoran desert as a canvas for vicissitude experiments in Phoenix nights. As a Tzimisce aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that A lithe, wiry woman of Romanian cast with an ageless ancilla bearing, and that first impression tends to hold under pressure. Their Nature reads as Architect, while their Demeanor performs as Deviant, 
...
Discipline cues to encode subtly: Vicissitude 4, Animalism 2, Auspex 2.
