# Harriet Webb — 3D Character Generation Prompt

## Metadata
- Character ID: `5e5686b1-3d0c-4361-8b84-6e1496f587d8`
...
### Identity
- Character Name: Harriet Webb
- Clan/Faction: Nosferatu
- Concept: Low-profile Anarch who owns Desert Star Market; left Camarilla with Darrell Buyers in 1960; defers to Alistaire on clan matters, ignores Camarilla politics.
...
Design language should communicate: Low-profile Anarch who owns Desert Star Market; left Camarilla with Darrell Buyers in 1960; defers to Alistaire on clan matters, ignores Camarilla politics.. Keep the visual psychology anchored in Survivor (inner driver) and Judge (public mask).
Appearance foundation: Harriet Webb presents a carefully managed visual identity that supports the role of low-profile anarch who owns desert star market; left camarilla with darrell buyers in 1960; defers to alistaire on clan matters, ignores camarilla politics. in Phoenix nights. As a Nosferatu aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Survivor, while their Demeanor performs as Judge, producing subtle contradictions that make them difficult to profile. Their posture, grooming, and timing imply trained situational awareness, with no wasted movement and no accidental tells. Disciplines including Obfuscate 4, Animalism 3, Potence 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 7, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without be
...
Primary powers: Obfuscate 4, Animalism 3, Potence 1
Traits: none listed
Abilities: Hermetic Lore, Occult, Ritual Theory, Expression, Performance
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Harriet Webb. Clan/faction: Nosferatu. Core concept: Low-profile Anarch who owns Desert Star Market; left Camarilla with Darrell Buyers in 1960; defers to Alistaire on clan matters, ignores Camarilla politics.. Psychological axis: Survivor (inner driver) + Judge (public mask).
...
Appearance direction: Harriet Webb presents a carefully managed visual identity that supports the role of low-profile anarch who owns desert star market; left camarilla with darrell buyers in 1960; defers to alistaire on clan matters, ignores camarilla politics. in Phoenix nights. As a Nosferatu aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as
...
Discipline cues to encode subtly: Obfuscate 4, Animalism 3, Potence 1.
