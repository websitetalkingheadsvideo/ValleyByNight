# Dr. Margaret Ashford — 3D Character Generation Prompt

## Metadata
- Character ID: `170c46c7-ec54-40eb-84fe-24fc8555bed0`
...
### Identity
- Character Name: Dr. Margaret Ashford
- Clan/Faction: Tremere
- Concept: Victorian Scholar
- Nature / Demeanor: Perfectionist / Pedagogue
...
Design language should communicate: Victorian Scholar. Keep the visual psychology anchored in Perfectionist (inner driver) and Pedagogue (public mask).
Appearance foundation: Dr. Margaret Ashford presents a carefully managed visual identity that supports the role of victorian scholar in Phoenix nights. As a Tremere aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Severe features, hair pulled back in a tight bun, wearing sharp modern business suits, and that first impression tends to hold under pressure. Their Nature reads as Perfectionist, while their Demeanor performs as Pedagogue, producing subtle contradictions that make them difficult to profile. Traits such as Analytical, Authoritative, Coordinated, Determined, Diplomatic, Elegant show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Hearth Path 3, Path of Warding 3, Auspex 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 7, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona b
...
Primary powers: Hearth Path 3, Path of Warding 3, Auspex 2
Traits: Analytical, Determined, Focused, Intelligent, Methodical, Patient, Rational, Scholarly, Wise, Coordinated, Precise, Steady-handed
Abilities: Academics, Awareness, Investigation, Linguistics, Occult, Alertness, Etiquette, Expression, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Dr. Margaret Ashford. Clan/faction: Tremere. Core concept: Victorian Scholar. Psychological axis: Perfectionist (inner driver) + Pedagogue (public mask).
...
Appearance direction: Dr. Margaret Ashford presents a carefully managed visual identity that supports the role of victorian scholar in Phoenix nights. As a Tremere aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Severe features, hair pulled back in a tight bun, wearing sharp modern business suits, and that first impression tends to hold under pressure. Their Nature reads as Perfectionist, while their Demeanor performs as Pedagogue, producing subtle contradictions that make them dif
...
Discipline cues to encode subtly: Hearth Path 3, Path of Warding 3, Auspex 2.
