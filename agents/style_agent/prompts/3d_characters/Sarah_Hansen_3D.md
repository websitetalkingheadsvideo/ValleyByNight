# Sarah Hansen — 3D Character Generation Prompt

## Metadata
- Character ID: `44d4db1d-fd06-4710-bf49-7d5fd0c94a68`
...
### Identity
- Character Name: Sarah Hansen
- Clan/Faction: Daughter of Cacophony
- Concept: Haunting chanteuse and nightclub owner whose voice carries supernatural beauty and melancholy.
- Nature / Demeanor: Sensualist / Confidant
- Sect Alignment: Independent
- Generation: 9
- Morality Context: Humanity, rating 7
...
Design language should communicate: Haunting chanteuse and nightclub owner whose voice carries supernatural beauty and melancholy.. Keep the visual psychology anchored in Sensualist (inner driver) and Confidant (public mask).
Appearance foundation: Sarah Hansen presents a carefully managed visual identity that supports the role of haunting chanteuse and nightclub owner whose voice carries supernatural beauty and melancholy. in Phoenix nights. As a Daughter of Cacophony aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Sensualist, while their Demeanor performs as Confidant, producing subtle contradictions that make them difficult to profile. Their posture, grooming, and timing imply trained situational awareness, with no wasted movement and no accidental tells. Disciplines including Melpominee 4, Presence 3, Auspex 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 7, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, in
...
Primary powers: Melpominee 4, Presence 3, Auspex 2
Traits: none listed
Abilities: Hermetic Lore, Occult, Ritual Theory, Alertness, Etiquette, Expression, Leadership, Performance, Seduction, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Sarah Hansen. Clan/faction: Daughter of Cacophony. Core concept: Haunting chanteuse and nightclub owner whose voice carries supernatural beauty and melancholy.. Psychological axis: Sensualist (inner driver) + Confidant (public mask).
...
Appearance direction: Sarah Hansen presents a carefully managed visual identity that supports the role of haunting chanteuse and nightclub owner whose voice carries supernatural beauty and melancholy. in Phoenix nights. As a Daughter of Cacophony aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Sensualist, while their Demeanor performs as Conf
...
Discipline cues to encode subtly: Melpominee 4, Presence 3, Auspex 2.
