# Marcus Webb — 3D Character Generation Prompt

## Metadata
- Character ID: `87f136dc-2ace-4462-bb8e-08deac6e8ab7`
...
### Identity
- Character Name: Marcus Webb
- Clan/Faction: Followers of Set
- Concept: Setite Club Manager
- Nature / Demeanor: Caregiver / Director
...
Design language should communicate: Setite Club Manager. Keep the visual psychology anchored in Caregiver (inner driver) and Director (public mask).
Appearance foundation: Marcus Webb presents a carefully managed visual identity that supports the role of setite club manager in Phoenix nights. As a Followers of Set aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Smooth operator in tailored business suits with subtle serpent-themed accessories, and that first impression tends to hold under pressure. Their Nature reads as Caregiver, while their Demeanor performs as Director, producing subtle contradictions that make them difficult to profile. Traits such as Analytical, Charismatic, Conflicted (between sire and childe), Creative, Dexterous, Diplomatic show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Obfuscate 2, Presence 2, Serpentis 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a
...
- Material style: silk and layered drape, gold accents, serpent motifs, opulent but aged finish
...
Primary powers: Obfuscate 2, Presence 2, Serpentis 2
Traits: Analytical, Conflicted (between sire and childe), Creative, Intelligent, Knowledgeable, Observant, Patient, Dexterous, Graceful, Quick, Steady, Charismatic
Abilities: Finance, Hermetic Lore, Law, Occult, Politics, Ritual Theory, Expression, Negotiation
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Marcus Webb. Clan/faction: Followers of Set. Core concept: Setite Club Manager. Psychological axis: Caregiver (inner driver) + Director (public mask).
...
Appearance direction: Marcus Webb presents a carefully managed visual identity that supports the role of setite club manager in Phoenix nights. As a Followers of Set aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Smooth operator in tailored business suits with subtle serpent-themed accessories, and that first impression tends to hold under pressure. Their Nature reads as Caregiver, while their Demeanor performs as Director, producing subtle contradictions that make them difficult 
...
Discipline cues to encode subtly: Obfuscate 2, Presence 2, Serpentis 2.
