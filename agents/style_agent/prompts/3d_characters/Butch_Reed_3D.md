# Butch Reed — 3D Character Generation Prompt

## Metadata
- Character ID: `83065a37-ab4a-4528-832c-9fe8ea07144e`
...
Design language should communicate: Enforcer. Keep the visual psychology anchored in Bravo (inner driver) and Survivor (public mask).
Appearance foundation: Butch Reed presents a carefully managed visual identity that supports the role of enforcer in Phoenix nights. As a Brujah aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Bravo, while their Demeanor performs as Survivor, producing subtle contradictions that make them difficult to profile. Their posture, grooming, and timing imply trained situational awareness, with no wasted movement and no accidental tells. Disciplines including potence 2, presence 2, celerity 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, and plausible innocence in equal measure.
...
Primary powers: potence 2, presence 2, celerity 1
Traits: none listed
Abilities: Hermetic Lore, Occult, Ritual Theory, Firearms, Etiquette, Expression, Performance
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Butch Reed. Clan/faction: Brujah. Core concept: Enforcer. Psychological axis: Bravo (inner driver) + Survivor (public mask).
...
Appearance direction: Butch Reed presents a carefully managed visual identity that supports the role of enforcer in Phoenix nights. As a Brujah aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Bravo, while their Demeanor performs as Survivor, producing subtle contradictions that make them difficult to profile. Their posture, grooming, and timi
...
Discipline cues to encode subtly: potence 2, presence 2, celerity 1.
