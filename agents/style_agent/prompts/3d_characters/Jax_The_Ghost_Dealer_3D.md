# Jax 'The Ghost Dealer' — 3D Character Generation Prompt

## Metadata
- Character ID: `e0628fec-f2d2-4bb6-9227-6ccf118bb9cd`
...
### Identity
- Character Name: Jax 'The Ghost Dealer'
- Clan/Faction: Ravnos
- Concept: Ravnos street grifter who sells ghost stories, charms, and talismans; sometimes their own illusions start manifesting.
- Nature / Demeanor: Trickster / Child
...
Design language should communicate: Ravnos street grifter who sells ghost stories, charms, and talismans; sometimes their own illusions start manifesting.. Keep the visual psychology anchored in Trickster (inner driver) and Child (public mask).
Appearance foundation: Jax 'The Ghost Dealer' presents a carefully managed visual identity that supports the role of ravnos street grifter who sells ghost stories, charms, and talismans; sometimes their own illusions start manifesting. in Phoenix nights. As a Ravnos aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Trickster, while their Demeanor performs as Child, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Chimerstry 3, Fortitude 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. Their moral center is less explicit in the record, but their styling still reads as controlled, purposeful, and anchored in long-term survival. Taken together, the result is memorabl
...
Primary powers: Chimerstry 3, Fortitude 1
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Awareness, Investigation, Occult, Stealth, Empathy, Intimidation, Streetwise, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Jax 'The Ghost Dealer'. Clan/faction: Ravnos. Core concept: Ravnos street grifter who sells ghost stories, charms, and talismans; sometimes their own illusions start manifesting.. Psychological axis: Trickster (inner driver) + Child (public mask).
...
Appearance direction: Jax 'The Ghost Dealer' presents a carefully managed visual identity that supports the role of ravnos street grifter who sells ghost stories, charms, and talismans; sometimes their own illusions start manifesting. in Phoenix nights. As a Ravnos aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Trickster, while their Demeano
...
Discipline cues to encode subtly: Chimerstry 3, Fortitude 1.
