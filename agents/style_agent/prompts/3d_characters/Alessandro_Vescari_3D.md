# Alessandro Vescari — 3D Character Generation Prompt

## Metadata
- Character ID: `feb2b3a3-ffeb-4fbb-91d4-50deea2e5119`
...
### Identity
- Character Name: Alessandro Vescari
- Clan/Faction: Giovanni
- Concept: Eldest of the House
...
Design language should communicate: Eldest of the House. Keep the visual psychology anchored in Architect (inner driver) and Director (public mask).
Appearance foundation: Alessandro Vescari presents a carefully managed visual identity that supports the role of eldest of the house in Phoenix nights. As a Giovanni aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Architect, while their Demeanor performs as Director, producing subtle contradictions that make them difficult to profile. Traits such as Analytical, Arrogant, Calculating, Charming, Composed, Diplomatic show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Dominate 3, Presence 3, Serpentis 3, Necromancy (Giovanni) 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negoti
...
Primary powers: Dominate 3, Presence 3, Serpentis 3, Necromancy (Giovanni) 2, Fortitude 1, Obfuscate 1
Traits: Analytical, Calculating, Insightful, Methodical, Obsessive, Perceptive, Scheming, Strategic, Fragile, Graceful, Precise, Unassuming
Abilities: Bureaucracy, Finance, Investigation, Occult, Politics, Alertness, Etiquette, Interrogation, Intimidation, Streetwise, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Alessandro Vescari. Clan/faction: Giovanni. Core concept: Eldest of the House. Psychological axis: Architect (inner driver) + Director (public mask).
...
Appearance direction: Alessandro Vescari presents a carefully managed visual identity that supports the role of eldest of the house in Phoenix nights. As a Giovanni aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Architect, while their Demeanor performs as Director, producing subtle contradictions that make them difficult to profile. Traits s
...
Discipline cues to encode subtly: Dominate 3, Presence 3, Serpentis 3, Necromancy (Giovanni) 2, Fortitude 1, Obfuscate 1.
