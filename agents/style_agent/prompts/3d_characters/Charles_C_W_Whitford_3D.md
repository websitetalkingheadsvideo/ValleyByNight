# Charles "C.W." Whitford — 3D Character Generation Prompt

## Metadata
- Character ID: `40a764ce-7465-42de-8cb9-b8eae2d3ff00`
...
### Identity
- Character Name: Charles "C.W." Whitford
- Clan/Faction: Ventrue
- Concept: Harpy & Real Estate Mogul
...
Design language should communicate: Harpy & Real Estate Mogul. Keep the visual psychology anchored in Architect (inner driver) and Director (public mask).
Appearance foundation: Charles "C.W." Whitford presents a carefully managed visual identity that supports the role of harpy & real estate mogul in Phoenix nights. As a Ventrue aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Architect, while their Demeanor performs as Director, producing subtle contradictions that make them difficult to profile. Traits such as Analytical, Arrogant, Authoritative, Calculating, Composed, Influential show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Dominate 4, Fortitude 3, Presence 3 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, in
...
Traits: Analytical, Calculating, Overconfident, Strategic, Composed, Arrogant, Authoritative, Influential, Manipulative, Persuasive
Abilities: Bureaucracy, Finance, Hermetic Lore, Investigation, Law, Occult, Politics, Ritual Theory, Expression, Interrogation, Intimidation, Leadership
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Charles "C.W." Whitford. Clan/faction: Ventrue. Core concept: Harpy & Real Estate Mogul. Psychological axis: Architect (inner driver) + Director (public mask).
...
Appearance direction: Charles "C.W." Whitford presents a carefully managed visual identity that supports the role of harpy & real estate mogul in Phoenix nights. As a Ventrue aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Architect, while their Demeanor performs as Director, producing subtle contradictions that make them difficult to profile
