# Sabine — 3D Character Generation Prompt

## Metadata
- Character ID: `7453f078-3440-48b9-aff1-04f294839d28`
...
- Concept: Twin Talon - Organization Specialist
...
Traits: Calculating, Clever, Focused, Methodical, Observant, Graceful, Lithe, Quick, Alluring, Callous, Charismatic, Elegant
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Sabine. Clan/faction: Toreador. Core concept: Twin Talon - Organization Specialist. Psychological axis: Conformist (inner driver) + Perfectionist (public mask).
...
Appearance direction: Sabine moves with the predatory grace of a panther in couture, every motion calculated to draw the eye while simultaneously making the observer question whether they want to be seen looking. Embraced at twenty-two in 1992, she presents as a woman frozen at the peak of her beauty—tall and lithe, with the kind of build that speaks to years of modeling and the kind of presence that makes photographers forget to breathe. Her face is a study in perfect symmetry: high cheekbones, a strong jawline softened by full lips, and eyes the color of dark hone
