# Tor — 3D Character Generation Prompt

## Metadata
- Character ID: `06ec86f4-4830-4035-856f-f5e85ee80fd4`
...
- Character Name: Tor
- Clan/Faction: Ghoul
- Concept: Apt pupil ghoul bound to Mr. Ashby
- Nature / Demeanor: Seeker / Traditionalist
...
Design language should communicate: Apt pupil ghoul bound to Mr. Ashby. Keep the visual psychology anchored in Seeker (inner driver) and Traditionalist (public mask).
Appearance foundation: Tor presents a carefully managed visual identity that supports the role of apt pupil ghoul bound to mr. ashby in Phoenix nights. As a Ghoul aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Haunted mortal ghoul with eyes that have seen too much death, too much grief, and that first impression tends to hold under pressure. Their Nature reads as Seeker, while their Demeanor performs as Traditionalist, producing subtle contradictions that make them difficult to profile. Traits such as Appearance, Charisma, Dexterity, Intelligence, Manipulation, Perception show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Obfuscate 1, Potence 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidatio
...
Primary powers: Obfuscate 1, Potence 1
Traits: Intelligence, Perception, Wits, Dexterity, Stamina, Strength, Appearance, Charisma, Manipulation
Abilities: Hermetic Lore, Occult, Ritual Theory, Stealth, Etiquette, Expression, Performance
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Tor. Clan/faction: Ghoul. Core concept: Apt pupil ghoul bound to Mr. Ashby. Psychological axis: Seeker (inner driver) + Traditionalist (public mask).
...
Appearance direction: Tor presents a carefully managed visual identity that supports the role of apt pupil ghoul bound to mr. ashby in Phoenix nights. As a Ghoul aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Haunted mortal ghoul with eyes that have seen too much death, too much grief, and that first impression tends to hold under pressure. Their Nature reads as Seeker, while their Demeanor performs as Traditionalist, producing subtle contradictions that make them difficult to pro
...
Discipline cues to encode subtly: Obfuscate 1, Potence 1.
