# Core (Alexandra Chen) — 3D Character Generation Prompt

## Metadata
- Character ID: `e1819e96-b510-4c82-8bcd-46515a00a0a7`
...
### Identity
- Character Name: Core (Alexandra Chen)
- Clan/Faction: Ghoul
- Concept: Former ghoul bodyguard with four domitors, now operating independently
- Nature / Demeanor: Survivor / Analyst
...
Primary powers: Dominate 1, Fortitude 1, Obfuscate 1, Potence 1
Traits: Cunning, Disciplined, Observant, Quick, Steady, Tough, Commanding, Intimidating
Abilities: Investigation, Security, Athletics, Brawl, Firearms, Melee, Stealth, Alertness, Intimidation, Streetwise, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Core (Alexandra Chen). Clan/faction: Ghoul. Core concept: Former ghoul bodyguard with four domitors, now operating independently. Psychological axis: Survivor (inner driver) + Analyst (public mask).
...
Appearance direction: Alexandra Chen moves through the shadows of Phoenix like a ghost who's learned to make the darkness work for her, her presence calculated to be noticed only when she wants to be. As a former ghoul bodyguard who has served four different domitors, she presents as a woman in her early thirties—though her actual age may be obscured by the vitae that has sustained her. She's of average height with a lean, athletic build that speaks to someone who's learned to move quickly and quietly, and her face carries the strong, expressive features of someone 
...
Discipline cues to encode subtly: Dominate 1, Fortitude 1, Obfuscate 1, Potence 1.
