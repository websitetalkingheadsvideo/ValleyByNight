# Sasha — 3D Character Generation Prompt

## Metadata
- Character ID: `ff9c67f2-a24c-41aa-8aa0-41e7c8e6a113`
...
Design language should communicate: Occult Specialist. Keep the visual psychology anchored in Visionary (inner driver) and Curmudgeon (public mask).
Appearance foundation: Sasha presents a carefully managed visual identity that supports the role of occult specialist in Phoenix nights. As a Tremere aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Visionary, while their Demeanor performs as Curmudgeon, producing subtle contradictions that make them difficult to profile. Traits such as Creative, Insightful, Inspiring, Intuitive, Perceptive, Reserved show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including auspex 3, dementation 3, dominate 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, and plausible innoc
...
Primary powers: auspex 3, dementation 3, dominate 1
Traits: Creative, Insightful, Intuitive, Perceptive, Unpredictable, Inspiring, Reserved
Abilities: Hermetic Lore, Occult, Ritual Theory, Alertness, Empathy, Etiquette, Expression, Performance
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Sasha. Clan/faction: Tremere. Core concept: Occult Specialist. Psychological axis: Visionary (inner driver) + Curmudgeon (public mask).
...
Appearance direction: Sasha presents a carefully managed visual identity that supports the role of occult specialist in Phoenix nights. As a Tremere aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Visionary, while their Demeanor performs as Curmudgeon, producing subtle contradictions that make them difficult to profile. Traits such as Creativ
...
Discipline cues to encode subtly: auspex 3, dementation 3, dominate 1.
