# James Whitmore — 3D Character Generation Prompt

## Metadata
- Character ID: `77e1968c-2d62-44e9-bb6f-3845a71f10ea`
...
### Identity
- Character Name: James Whitmore
- Clan/Faction: Tremere
- Concept: PR Executive
...
Design language should communicate: PR Executive. Keep the visual psychology anchored in Director (inner driver) and Capitalist (public mask).
Appearance foundation: James Whitmore presents a carefully managed visual identity that supports the role of pr executive in Phoenix nights. As a Tremere aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Charismatic, perfectly groomed, and always carrying the latest tech, and that first impression tends to hold under pressure. Their Nature reads as Director, while their Demeanor performs as Capitalist, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Assertive, Calculating, Charismatic, Charming, Clever show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Thaumaturgy 5, Dominate 3, Auspex 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 7, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, and plausible i
...
Primary powers: Thaumaturgy 5, Dominate 3, Auspex 2
Traits: Calculating, Clever, Focused, Intelligent, Patient, Shrewd, Strategic, Alert, Coordinated, Quick, Assertive, Charismatic
Abilities: Academics, Finance, Investigation, Occult, Politics, Empathy, Etiquette, Expression, Intimidation, Leadership, Streetwise, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: James Whitmore. Clan/faction: Tremere. Core concept: PR Executive. Psychological axis: Director (inner driver) + Capitalist (public mask).
...
Appearance direction: James Whitmore presents a carefully managed visual identity that supports the role of pr executive in Phoenix nights. As a Tremere aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Charismatic, perfectly groomed, and always carrying the latest tech, and that first impression tends to hold under pressure. Their Nature reads as Director, while their Demeanor performs as Capitalist, producing subtle contradictions that make them difficult to profile. Traits such as
...
Discipline cues to encode subtly: Thaumaturgy 5, Dominate 3, Auspex 2.
