# Julian Vane — 3D Character Generation Prompt

## Metadata
- Character ID: `7e5de294-dcb6-489e-9def-b8e6e9d85659`
...
### Identity
- Character Name: Julian Vane
- Clan/Faction: Tremere
- Concept: Regent of the Chantry
...
Design language should communicate: Regent of the Chantry. Keep the visual psychology anchored in Perfectionist (inner driver) and Director (public mask).
Appearance foundation: Julian Vane presents a carefully managed visual identity that supports the role of regent of the chantry in Phoenix nights. As a Tremere aligned with Camarilla politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Perfectionist, while their Demeanor performs as Director, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 2, Dominate 2, Thaumaturgy 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, and plausible innocenc
...
Abilities: Academics, Hermetic Lore, Linguistics, Occult, Research, Ritual Theory, Alertness, Empathy, Etiquette, Expression, Intimidation, Leadership
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Julian Vane. Clan/faction: Tremere. Core concept: Regent of the Chantry. Psychological axis: Perfectionist (inner driver) + Director (public mask).
...
Appearance direction: Julian Vane presents a carefully managed visual identity that supports the role of regent of the chantry in Phoenix nights. As a Tremere aligned with Camarilla politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Perfectionist, while their Demeanor performs as Director, producing subtle contradictions that make them difficult to profile. Traits such 
