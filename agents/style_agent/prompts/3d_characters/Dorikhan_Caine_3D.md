# Dorikhan Caine — 3D Character Generation Prompt

## Metadata
- Character ID: `0a8a23d6-9e25-4706-a53c-3c667b02aec0`
...
### Identity
- Character Name: Dorikhan Caine
- Clan/Faction: Gangrel
- Concept: Gangrel Autark with Koldunic Sorcery
...
Design language should communicate: Gangrel Autark with Koldunic Sorcery. Keep the visual psychology anchored in Survivor (inner driver) and Judge (public mask).
Appearance foundation: Dorikhan Caine presents a carefully managed visual identity that supports the role of gangrel autark with koldunic sorcery in Phoenix nights. As a Gangrel aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Survivor, while their Demeanor performs as Judge, producing subtle contradictions that make them difficult to profile. Their posture, grooming, and timing imply trained situational awareness, with no wasted movement and no accidental tells. Disciplines including Fortitude 5, Koldunic Sorcery 5, Potence 5, Protean 5 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 7, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, and plausible innocence in equal measure.
...
Primary powers: Fortitude 5, Koldunic Sorcery 5, Potence 5, Protean 5, Animalism 3, Celerity 3
Traits: none listed
Abilities: Hermetic Lore, Occult, Ritual Theory, Survival, Tracking, Etiquette, Expression, Performance
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Dorikhan Caine. Clan/faction: Gangrel. Core concept: Gangrel Autark with Koldunic Sorcery. Psychological axis: Survivor (inner driver) + Judge (public mask).
...
Appearance direction: Dorikhan Caine presents a carefully managed visual identity that supports the role of gangrel autark with koldunic sorcery in Phoenix nights. As a Gangrel aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Survivor, while their Demeanor performs as Judge, producing subtle contradictions that make them difficult to profile. 
...
Discipline cues to encode subtly: Fortitude 5, Koldunic Sorcery 5, Potence 5, Protean 5, Animalism 3, Celerity 3.
