# Marcus Vane — 3D Character Generation Prompt

## Metadata
- Character ID: `95c9211d-8fbe-4f74-8ea2-48476fa065f8`
...
### Identity
- Character Name: Marcus Vane
- Clan/Faction: Tremere
- Concept: Digital Saboteur & Chantry Auditor
- Nature / Demeanor: Architect / Professional
...
Design language should communicate: Digital Saboteur & Chantry Auditor. Keep the visual psychology anchored in Architect (inner driver) and Professional (public mask).
Appearance foundation: Marcus Vane presents a carefully managed visual identity that supports the role of digital saboteur & chantry auditor in Phoenix nights. As a Tremere aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that A man in a sharp, slightly dated charcoal suit, always carrying a bulky black laptop bag, and that first impression tends to hold under pressure. Their Nature reads as Architect, while their Demeanor performs as Professional, producing subtle contradictions that make them difficult to profile. Their posture, grooming, and timing imply trained situational awareness, with no wasted movement and no accidental tells. Disciplines including Thaumaturgy: Path of Technomancy 3, Thaumaturgy: Path of the Focused Mind 2, Auspex 1, Dominate 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. Their moral center is less explicit in the record, but their styling still reads as controlled, purposeful, and anchored in long-term survival. Taken together, the result is memorable without being loud: a persona built for 
...
Primary powers: Thaumaturgy: Path of Technomancy 3, Thaumaturgy: Path of the Focused Mind 2, Auspex 1, Dominate 1
Traits: none listed
Abilities: Academics, Linguistics, Occult, Research, Ritual Theory
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Marcus Vane. Clan/faction: Tremere. Core concept: Digital Saboteur & Chantry Auditor. Psychological axis: Architect (inner driver) + Professional (public mask).
...
Appearance direction: Marcus Vane presents a carefully managed visual identity that supports the role of digital saboteur & chantry auditor in Phoenix nights. As a Tremere aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that A man in a sharp, slightly dated charcoal suit, always carrying a bulky black laptop bag, and that first impression tends to hold under pressure. Their Nature reads as Architect, while their Demeanor performs as Professional, producing subtle contradictions that mak
...
Discipline cues to encode subtly: Thaumaturgy: Path of Technomancy 3, Thaumaturgy: Path of the Focused Mind 2, Auspex 1, Dominate 1.
