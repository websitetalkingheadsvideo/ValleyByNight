# Bayside Bob — 3D Character Generation Prompt

## Metadata
- Character ID: `6c525877-2e26-4826-87f4-becf96bee98b`
...
### Identity
- Character Name: Bayside Bob
- Clan/Faction: Toreador
- Concept: Tiki Bar Owner / Anarch Liaison
...
Design language should communicate: Tiki Bar Owner / Anarch Liaison. Keep the visual psychology anchored in Survivor (inner driver) and Conformist (public mask).
Appearance foundation: Bayside Bob presents a carefully managed visual identity that supports the role of tiki bar owner / anarch liaison in Phoenix nights. As a Toreador aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Retro Hawaiian shirts and a Bali Hai ball cap; smells of rum and coconut sunscreen, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Conformist, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Athletic, Awkward, Charismatic, Charming, Clever show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 3, Presence 3, Celerity 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intim
...
Traits: Clever, Creative, Intelligent, Observant, Studious, Alert, Athletic, Graceful, Nimble, Quick, Resilient, Awkward
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Bayside Bob. Clan/faction: Toreador. Core concept: Tiki Bar Owner / Anarch Liaison. Psychological axis: Survivor (inner driver) + Conformist (public mask).
...
Appearance direction: Bayside Bob presents a carefully managed visual identity that supports the role of tiki bar owner / anarch liaison in Phoenix nights. As a Toreador aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Retro Hawaiian shirts and a Bali Hai ball cap; smells of rum and coconut sunscreen, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Conformist, producing subtle contradictions that make them diff
