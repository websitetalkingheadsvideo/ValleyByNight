# Elijah Crenshaw — 3D Character Generation Prompt

## Metadata
- Character ID: `5bb565ec-463b-4779-889a-e53da7408439`
...
### Identity
- Character Name: Elijah Crenshaw
- Clan/Faction: Brujah
- Concept: The Staked Prince of Phoenix
- Nature / Demeanor: Autocrat / Elder
...
Design language should communicate: The Staked Prince of Phoenix. Keep the visual psychology anchored in Autocrat (inner driver) and Elder (public mask).
Appearance foundation: Elijah Crenshaw presents a carefully managed visual identity that supports the role of the staked prince of phoenix in Phoenix nights. As a Brujah aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Currently staked and hidden; his presence is felt as whispers on the desert wind, and that first impression tends to hold under pressure. Their Nature reads as Autocrat, while their Demeanor performs as Elder, producing subtle contradictions that make them difficult to profile. Traits such as Ancient, Patient, Regal, Resilient, Terrifying, Wise show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Presence 5, Celerity 4, Potence 4 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, a
...
Primary powers: Presence 5, Celerity 4, Potence 4
Traits: Patient, Wise, Ancient, Resilient, Regal, Terrifying
Abilities: Hermetic Lore, Occult, Ritual Theory, Animal Ken, Survival, Tracking, Alertness, Empathy, Etiquette, Expression, Leadership, Performance
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Elijah Crenshaw. Clan/faction: Brujah. Core concept: The Staked Prince of Phoenix. Psychological axis: Autocrat (inner driver) + Elder (public mask).
...
Appearance direction: Elijah Crenshaw presents a carefully managed visual identity that supports the role of the staked prince of phoenix in Phoenix nights. As a Brujah aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Currently staked and hidden; his presence is felt as whispers on the desert wind, and that first impression tends to hold under pressure. Their Nature reads as Autocrat, while their Demeanor performs as Elder, producing subtle contradictions that make them difficult to
...
Discipline cues to encode subtly: Presence 5, Celerity 4, Potence 4.
