# Azarakh Brain Bug — 3D Character Generation Prompt

## Metadata
- Character ID: `bf5c1453-c03a-4463-b6a5-4529a29f8deb`
...
### Identity
- Character Name: Azarakh Brain Bug
- Clan/Faction: Spirit
- Concept: Spirit Parasite / Mind Controller
- Nature / Demeanor: Deviant / Monster
...
Design language should communicate: Spirit Parasite / Mind Controller. Keep the visual psychology anchored in Deviant (inner driver) and Monster (public mask).
Appearance foundation: Azarakh Brain Bug presents a carefully managed visual identity that supports the role of spirit parasite / mind controller in Phoenix nights. As a Spirit aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Spider-like creature the size of a housecat, perched on victim's head with fangs sunk into skull, and that first impression tends to hold under pressure. Their Nature reads as Deviant, while their Demeanor performs as Monster, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 2, Celerity 2, Fortitude 2, Potence 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. Their moral center is less explicit in the record, but their styling still reads as controlled, purposeful, and anchored in long-term survival. Taken together, the result is memorable without being loud: a persona built
...
Primary powers: Auspex 2, Celerity 2, Fortitude 2, Potence 2
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Awareness, Occult, Ritual Theory, Alertness, Empathy, Intimidation, Subterfuge
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Azarakh Brain Bug. Clan/faction: Spirit. Core concept: Spirit Parasite / Mind Controller. Psychological axis: Deviant (inner driver) + Monster (public mask).
...
Appearance direction: Azarakh Brain Bug presents a carefully managed visual identity that supports the role of spirit parasite / mind controller in Phoenix nights. As a Spirit aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Spider-like creature the size of a housecat, perched on victim's head with fangs sunk into skull, and that first impression tends to hold under pressure. Their Nature reads as Deviant, while their Demeanor performs as Monster, producing subtle contradictions tha
...
Discipline cues to encode subtly: Auspex 2, Celerity 2, Fortitude 2, Potence 2.
