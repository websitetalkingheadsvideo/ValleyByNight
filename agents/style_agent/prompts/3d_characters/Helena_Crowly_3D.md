# Helena Crowly — 3D Character Generation Prompt

## Metadata
- Character ID: `018cf55a-2ffb-4827-ab9c-6c96fce0adec`
...
### Identity
- Character Name: Helena Crowly
- Clan/Faction: Tremere
- Concept: Tremere occult archaeologist and forensic thaumaturge
- Nature / Demeanor: Architect / Teacher
...
Design language should communicate: Tremere occult archaeologist and forensic thaumaturge. Keep the visual psychology anchored in Architect (inner driver) and Teacher (public mask).
Appearance foundation: Helena Crowly presents a carefully managed visual identity that supports the role of tremere occult archaeologist and forensic thaumaturge in Phoenix nights. As a Tremere aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that An unnervingly precise young woman in charcoal skirts and ivory blouses, with inhumanly flawless features and a chill that follows her into every room, and that first impression tends to hold under pressure. Their Nature reads as Architect, while their Demeanor performs as Teacher, producing subtle contradictions that make them difficult to profile. Traits such as Aloof, Analytical, Authoritative, Charming, Commanding, Dextrous show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Thaumaturgy: Path of Blood 5, Thaumaturgy: Path of Mercury 5, Thaumaturgy: Path of Conjuring 4, Auspex 3 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cult
...
Primary powers: Thaumaturgy: Path of Blood 5, Thaumaturgy: Path of Mercury 5, Thaumaturgy: Path of Conjuring 4, Auspex 3, Dominate 2
Traits: Analytical, Insightful, Methodical, Obsessive, Obsessive-Compulsive, Perceptive, Dextrous, Frail, Graceful, Aloof, Authoritative, Charming
Abilities: Academics, Bureaucracy, Investigation, Law, Linguistics, Occult, Politics, Firearms, Melee, Stealth, Alertness, Empathy
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Helena Crowly. Clan/faction: Tremere. Core concept: Tremere occult archaeologist and forensic thaumaturge. Psychological axis: Architect (inner driver) + Teacher (public mask).
...
Appearance direction: Helena Crowly presents a carefully managed visual identity that supports the role of tremere occult archaeologist and forensic thaumaturge in Phoenix nights. As a Tremere aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that An unnervingly precise young woman in charcoal skirts and ivory blouses, with inhumanly flawless features and a chill that follows her into every room, and that first impression tends to hold under pressure. Their Nature reads as Architect, whil
...
Discipline cues to encode subtly: Thaumaturgy: Path of Blood 5, Thaumaturgy: Path of Mercury 5, Thaumaturgy: Path of Conjuring 4, Auspex 3, Dominate 2.
