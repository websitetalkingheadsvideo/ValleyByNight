# Lorenzo Giovanni — 3D Character Generation Prompt

## Metadata
- Character ID: `c6ab6864-aee3-44e1-98e6-e219aef46c90`
...
### Identity
- Character Name: Lorenzo Giovanni
- Clan/Faction: Giovanni
- Concept: Giovanni Enforcer / Fleshcrafted Weapon
- Nature / Demeanor: Sadist / Bravo
...
Design language should communicate: Giovanni Enforcer / Fleshcrafted Weapon. Keep the visual psychology anchored in Sadist (inner driver) and Bravo (public mask).
Appearance foundation: Lorenzo Giovanni presents a carefully managed visual identity that supports the role of giovanni enforcer / fleshcrafted weapon in Phoenix nights. As a Giovanni aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that 6'5", 300lbs of solid muscle, and that first impression tends to hold under pressure. Their Nature reads as Sadist, while their Demeanor performs as Bravo, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Celerity 5, Potence 5, Brujah: Iron Heart 4, Fortitude 4 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 6, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, and plausible innoc
...
Primary powers: Celerity 5, Potence 5, Brujah: Iron Heart 4, Fortitude 4, Dominate 3, Necromancy: Sepulchre Path 3
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Lorenzo Giovanni. Clan/faction: Giovanni. Core concept: Giovanni Enforcer / Fleshcrafted Weapon. Psychological axis: Sadist (inner driver) + Bravo (public mask).
...
Appearance direction: Lorenzo Giovanni presents a carefully managed visual identity that supports the role of giovanni enforcer / fleshcrafted weapon in Phoenix nights. As a Giovanni aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that 6'5", 300lbs of solid muscle, and that first impression tends to hold under pressure. Their Nature reads as Sadist, while their Demeanor performs as Bravo, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring
...
Discipline cues to encode subtly: Celerity 5, Potence 5, Brujah: Iron Heart 4, Fortitude 4, Dominate 3, Necromancy: Sepulchre Path 3.
