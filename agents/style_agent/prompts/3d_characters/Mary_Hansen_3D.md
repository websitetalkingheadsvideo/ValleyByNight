# Mary Hansen — 3D Character Generation Prompt

## Metadata
- Character ID: `4a3ebf44-0dc9-456f-8583-5717a648caaa`
...
### Identity
- Character Name: Mary Hansen
- Clan/Faction: Ventrue
- Concept: Corporate Liaison
...
Design language should communicate: Corporate Liaison. Keep the visual psychology anchored in Director (inner driver) and Capitalist (public mask).
Appearance foundation: Mary Hansen presents a carefully managed visual identity that supports the role of corporate liaison in Phoenix nights. As a Ventrue aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Director, while their Demeanor performs as Capitalist, producing subtle contradictions that make them difficult to profile. Their posture, grooming, and timing imply trained situational awareness, with no wasted movement and no accidental tells. Disciplines including Dominate 2, Fortitude 2, Presence 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, and plausible innocence in equal measure.
...
Primary powers: Dominate 2, Fortitude 2, Presence 2
Traits: none listed
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Mary Hansen. Clan/faction: Ventrue. Core concept: Corporate Liaison. Psychological axis: Director (inner driver) + Capitalist (public mask).
...
Appearance direction: Mary Hansen presents a carefully managed visual identity that supports the role of corporate liaison in Phoenix nights. As a Ventrue aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Director, while their Demeanor performs as Capitalist, producing subtle contradictions that make them difficult to profile. Their posture, gr
...
Discipline cues to encode subtly: Dominate 2, Fortitude 2, Presence 2.
