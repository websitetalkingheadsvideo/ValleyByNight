# Darnelle Jones — 3D Character Generation Prompt

## Metadata
- Character ID: `acdb5d93-a350-4902-992f-dd324e98ba13`
...
### Identity
- Character Name: Darnelle Jones
- Clan/Faction: Wraith
- Concept: Vengeful Ghost / Anti-Vampire Protector
- Nature / Demeanor: Judge / Protector
...
Design language should communicate: Vengeful Ghost / Anti-Vampire Protector. Keep the visual psychology anchored in Judge (inner driver) and Protector (public mask).
Appearance foundation: Darnelle Jones presents a carefully managed visual identity that supports the role of vengeful ghost / anti-vampire protector in Phoenix nights. As a Wraith aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Pretty, but not spectacularly beautiful woman in her mid-20s, and that first impression tends to hold under pressure. Their Nature reads as Judge, while their Demeanor performs as Protector, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 2, Chimerstry 2, Dementation 1, Dominate 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. Their moral center is less explicit in the record, but their styling still reads as controlled, purposeful, and anchored in long-term survival. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidati
...
Primary powers: Auspex 2, Chimerstry 2, Dementation 1, Dominate 1, Vicissitude 1
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Academics, Awareness, Computer, Crafts, Investigation, Law, Occult, Politics, Athletics, Brawl, Drive, Stealth
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Darnelle Jones. Clan/faction: Wraith. Core concept: Vengeful Ghost / Anti-Vampire Protector. Psychological axis: Judge (inner driver) + Protector (public mask).
...
Appearance direction: Darnelle Jones presents a carefully managed visual identity that supports the role of vengeful ghost / anti-vampire protector in Phoenix nights. As a Wraith aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Pretty, but not spectacularly beautiful woman in her mid-20s, and that first impression tends to hold under pressure. Their Nature reads as Judge, while their Demeanor performs as Protector, producing subtle contradictions that make them difficult to profile.
...
Discipline cues to encode subtly: Auspex 2, Chimerstry 2, Dementation 1, Dominate 1, Vicissitude 1.
