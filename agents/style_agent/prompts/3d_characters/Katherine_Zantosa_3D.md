# Katherine Zantosa — 3D Character Generation Prompt

## Metadata
- Character ID: `41af91c7-2454-4676-8aeb-2348b68b40e2`
...
### Identity
- Character Name: Katherine Zantosa
- Clan/Faction: Ghoul
- Concept: Corporate Face / Social Revenant Executive
- Nature / Demeanor: Survivor / Director
...
Design language should communicate: Corporate Face / Social Revenant Executive. Keep the visual psychology anchored in Survivor (inner driver) and Director (public mask).
Appearance foundation: Katherine Zantosa presents a carefully managed visual identity that supports the role of corporate face / social revenant executive in Phoenix nights. As a Ghoul aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Beautiful woman of medium height and build, with shoulder-length, silver-blond hair and blue eyes, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Director, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Auspex 3, Presence 3, Vicissitude 3, Celerity 1 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 6, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: 
...
Primary powers: Auspex 3, Presence 3, Vicissitude 3, Celerity 1, Fortitude 1, Potence 1
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Finance, Hermetic Lore, Law, Occult, Politics, Ritual Theory, Alertness, Empathy, Etiquette, Expression, Intimidation, Leadership
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Katherine Zantosa. Clan/faction: Ghoul. Core concept: Corporate Face / Social Revenant Executive. Psychological axis: Survivor (inner driver) + Director (public mask).
...
Appearance direction: Katherine Zantosa presents a carefully managed visual identity that supports the role of corporate face / social revenant executive in Phoenix nights. As a Ghoul aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Beautiful woman of medium height and build, with shoulder-length, silver-blond hair and blue eyes, and that first impression tends to hold under pressure. Their Nature reads as Survivor, while their Demeanor performs as Director, producing subtle contrad
...
Discipline cues to encode subtly: Auspex 3, Presence 3, Vicissitude 3, Celerity 1, Fortitude 1, Potence 1.
