# Ardvark — 3D Character Generation Prompt

## Metadata
- Character ID: `322c28ab-3fa6-4f1d-a777-1e9bff2deb4c`
...
### Identity
- Character Name: Ardvark
- Clan/Faction: Gangrel
- Concept: Desert Gangrel Scout
...
Design language should communicate: Desert Gangrel Scout. Keep the visual psychology anchored in Survivor (inner driver) and Loner (public mask).
Appearance foundation: Ardvark presents a carefully managed visual identity that supports the role of desert gangrel scout in Phoenix nights. As a Gangrel aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Survivor, while their Demeanor performs as Loner, producing subtle contradictions that make them difficult to profile. Traits such as Alert, Alluring, Athletic, Attentive, Bestial, Calm show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Animalism 2, Fortitude 2, Protean 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. Their moral center is less explicit in the record, but their styling still reads as controlled, purposeful, and anchored in long-term survival. Taken together, the result is memorable without being loud: a persona built for negotiation, intimidation, and plausible innocence in equal m
...
Primary powers: Animalism 2, Fortitude 2, Protean 2
Traits: Alert, Attentive, Calm, Creative, Dedicated, Forgetful, Athletic, Clumsy, Energetic, Ferocious, Alluring, Bestial
Abilities: Athletics, Drive, Survival, Tracking, Etiquette, Expression, Performance
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Ardvark. Clan/faction: Gangrel. Core concept: Desert Gangrel Scout. Psychological axis: Survivor (inner driver) + Loner (public mask).
...
Appearance direction: Ardvark presents a carefully managed visual identity that supports the role of desert gangrel scout in Phoenix nights. As a Gangrel aligned with Independent politics, their look is built to communicate competence before a word is spoken. There is no old appearance entry, but repeated sightings describe a silhouette designed for control, recognition, and deniability at the same time. Their Nature reads as Survivor, while their Demeanor performs as Loner, producing subtle contradictions that make them difficult to profile. Traits such as Alert, A
...
Discipline cues to encode subtly: Animalism 2, Fortitude 2, Protean 2.
