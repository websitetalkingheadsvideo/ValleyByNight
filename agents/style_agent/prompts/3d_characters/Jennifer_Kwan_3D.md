# Jennifer Kwan — 3D Character Generation Prompt

## Metadata
- Character ID: `71a34604-84b0-4aaa-8d50-78749b465223`
...
### Identity
- Character Name: Jennifer Kwan
- Clan/Faction: Followers of Set
- Concept: Setite Security Chief
- Nature / Demeanor: Competitor / Director
...
Design language should communicate: Setite Security Chief. Keep the visual psychology anchored in Competitor (inner driver) and Director (public mask).
Appearance foundation: Jennifer Kwan presents a carefully managed visual identity that supports the role of setite security chief in Phoenix nights. As a Followers of Set aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Tactical gear that never looks out of place—dark cargo pants and polished combat boots, and that first impression tends to hold under pressure. Their Nature reads as Competitor, while their Demeanor performs as Director, producing subtle contradictions that make them difficult to profile. Traits such as Agile, Alert, Analytical, Callous, Charismatic, Commanding show in stance, grooming, and eye contact, turning presentation into tactical advantage rather than vanity. Disciplines including Presence 2, Serpentis 2 reinforce the effect: attention shifts where they want it, tension rises or drops on cue, and witnesses remember exactly what they were meant to remember. With Humanity at 5, appearance is also armor against the Beast; they cultivate ritualized habits that keep predation from becoming carelessness. Taken together, the result is memorable without being loud: a persona built for negotiation, intimid
...
Primary powers: Presence 2, Serpentis 2
Traits: Alert, Analytical, Cunning, Cynical, Disciplined, Intelligent, Observant, Patient, Agile, Dexterous, Lithe, Quick
...
Create a full-body 3D character for Blender text-to-3D, in a semi-realistic Gothic-Noir style consistent with Valley by Night (Phoenix 1994). Character: Jennifer Kwan. Clan/faction: Followers of Set. Core concept: Setite Security Chief. Psychological axis: Competitor (inner driver) + Director (public mask).
...
Appearance direction: Jennifer Kwan presents a carefully managed visual identity that supports the role of setite security chief in Phoenix nights. As a Followers of Set aligned with Independent politics, their look is built to communicate competence before a word is spoken. Witnesses first notice that Tactical gear that never looks out of place—dark cargo pants and polished combat boots, and that first impression tends to hold under pressure. Their Nature reads as Competitor, while their Demeanor performs as Director, producing subtle contradictions that make them 
...
Discipline cues to encode subtly: Presence 2, Serpentis 2.
