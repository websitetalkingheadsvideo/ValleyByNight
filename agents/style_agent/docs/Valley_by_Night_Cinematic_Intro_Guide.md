...
## 🎬 **Purpose**
Each *Cinematic Intro* serves as a short (30–60 second) film vignette that defines a character's presence, tone, and mythology within *Valley by Night*.  
...
Use a **hybrid screenplay / narrative format**, combining cinematic clarity with the lyrical, stylized narration that defines *Valley by Night*.  
...
| **End Cards** | Bold caps centered | Example: **VALLEY BY NIGHT – CHAPTER ONE: THE PRINCE IS DEAD** |
...
- All intros end with the **signature title card**:  
  ```
  [CUT TO BLACK]  
  **VALLEY BY NIGHT – [Subtitle or Chapter Title]**
  ```  
