...
class CharacterRitualsRepository
{
     ...
     * 
     * Supports both ritual_id FK lookup (if it exists) and fallback to 
     * (ritual_name, ritual_type, level) matching.
     * 
    ...
    {
        // First, try to match by name/type/level (current schema doesn't have ritual_id FK)
