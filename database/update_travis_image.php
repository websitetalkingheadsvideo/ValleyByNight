<?php
/**
 * Update Travis Adelson Image Script
 */
...
$character_name = 'Travis Adelson';
$image_filename = 'Travis Adelson.png';

if (!$is_cli) {
    echo "<!DOCTYPE html><html><head><title>Travis Image Update</title></head><body>";
    echo "<h1>Travis Adelson Image Update</h1>";
    echo "<pre>";
}
