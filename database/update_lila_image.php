<?php
/**
 * Update Lila Moreno Image Script
 */
...
$character_name = 'Lila Moreno';
$image_filename = 'Lila Moreno.png';

if (!$is_cli) {
    echo "<!DOCTYPE html><html><head><title>Lila Image Update</title></head><body>";
    echo "<h1>Lila Moreno Image Update</h1>";
    echo "<pre>";
}
