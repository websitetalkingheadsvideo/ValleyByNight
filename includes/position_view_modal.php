                ...
                <form id="positionForm">
                    ...
                    <div class="mb-3">
                        ...
                        <div id="currentHolderInfo" class="p-3 bg-dark border border-danger rounded">
                            <p class="text-light mb-0">Loading...</p>
                        </div>
...
(function() {
    ...
    function setLoadingState() {
        ...
        if (holderInfo) holderInfo.innerHTML = '<p class="text-light mb-0">Loading...</p>';
        
        const history = document.getElementById('positionHistory');
        if (history) history.innerHTML = '<p class="text-light mb-0">Loading...</p>';
    }
    ...
    function renderCurrentHolder(mode) {
        ...
        if (mode === 'edit') {
            ...
            if (!holder) {
                holderInfo.innerHTML = '<p class="text-light mb-0">Position is vacant</p>';
                return;
            }
    ...
    function renderHistory() {
        ...
        if (history.length === 0) {
            historyEl.innerHTML = '<p class="text-light mb-0">No assignment history</p>';
            return;
        }
