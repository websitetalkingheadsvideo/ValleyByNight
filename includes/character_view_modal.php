        ...
        if (isGhoul && currentViewData.ghoul_overlay) {
            ...
            if (overlay.custom_data) {
                ...
                try {
                    ...
                    optionalFieldsHtml += '<summary><strong>Custom Data</strong> <span class="text-light small">(JSON)</span></summary>';
                    ...
                    optionalFieldsHtml += '<div class="col-12"><p><strong>Custom Data:</strong> <span class="text-light">(Invalid JSON)</span></p></div>';
                }
            }
