# Werewolf Character Sheet Template – Database Mapping

Use **werewolf_character_template.json** as the base for new Werewolf: The Apocalypse LARP characters (Mind's Eye Theatre / By Night Studios style). Fill in fields and import with:
