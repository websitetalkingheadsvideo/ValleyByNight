    ...
    <div class="d-flex align-items-center justify-content-center min-vh-100 p-4">
        <div class="card" style="max-width: 450px; width: 100%;">
            <div class="card-body p-4">
                ...
                <p class="text-center mb-4 login-subtitle">Enter your credentials to access the chronicle</p>
                ...
                <?php else: ?>
                    ...
                    <form action="includes/login_process.php" method="POST" class="d-flex flex-column gap-3 needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="usernameHelp" class="mt-1 login-helper">Enter your account username.</div>
