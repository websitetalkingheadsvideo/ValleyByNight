...
$char = db_fetch_one($conn, "SELECT * FROM mage_characters WHERE id = ?", 'i', [$id]);
if (!$char) { echo json_encode(['success' => false, 'message' => 'Not found']); exit; }
$jsonFields = ['instruments', 'quintessence', 'paradox', 'spheres', 'attributes', 'abilities', 'rotes', 'backgrounds', 'backgroundDetails', 'merits_flaws', 'health_levels', 'relationships', 'custom_data'];
