<?php
/**
 * Supernatural Entities Admin Panel
 */
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <h1 class="mb-4">Supernatural Entities Management</h1>
                ...
                <table class="character-table table table-dark table-hover align-middle mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center text-nowrap">Entity Type</th>
                            <th class="text-center text-nowrap">Subtype</th>
                    ...
                    <tbody>
                        ...
                        try {
                            ...
                            error_log('supernatural_entities_admin_panel: supernatural_entities query failed: ' . $e->getMessage());
                            $rows = [];
                        ...
                        elseif (empty($rows)) { echo "<tr><td colspan='5' class='text-center'>No Supernatural entities found.</td></tr>"; } else {
                            foreach ($rows as $c) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo htmlspecialchars($c['entity_type'] ?? '—'); ?></td>
                                    <td class="text-center"><?php echo htmlspecialchars($c['entity_subtype'] ?? '—'); ?></td>
...
<?php $apiEndpoint = '/admin/view_supernatural_entity_api.php'; $modalId = 'viewCharacterModal'; include __DIR__ . '/../includes/character_view_modal.php'; ?>
<script>
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.delete-btn').forEach(function(b) {
        b.addEventListener('click', function() {
            ...
            fetch('/admin/delete_supernatural_entity_api.php', { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify({ character_id: this.dataset.id }) })
