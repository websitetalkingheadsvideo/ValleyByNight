...
$char = db_fetch_one($conn, "SELECT * FROM mortal_characters WHERE id = ?", 'i', [$id]);
if (!$char) { echo json_encode(['success' => false, 'message' => 'Not found']); exit; }
$jsonFields = ['attributes', 'abilities', 'powers', 'backgrounds', 'backgroundDetails', 'merits_flaws', 'health_levels', 'relationships', 'custom_data'];
